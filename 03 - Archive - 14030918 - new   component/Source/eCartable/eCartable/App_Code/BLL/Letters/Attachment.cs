...
namespace Cartable.Bll.Letters
{
    public class Attachment : BllObject
    {
        ...
        public static int GetPageNumber(int extention, int letterId)
        {
            try
            {
        ...
        public static int GetExtentionID(string Extention)
        {
            try
            {
                return ((AttachmentProvider)Instance).GetExtentionID(Extention);
            }
            catch (CartableExceptions er)
            {
                if (onException != null)
