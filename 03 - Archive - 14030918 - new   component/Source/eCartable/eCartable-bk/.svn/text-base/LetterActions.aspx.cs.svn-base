    ...
    public partial class LetterActions : BaseForm
    {
        ...
        protected void btnNewAttach_Click(object sender, ImageClickEventArgs e)
        {
            if (filePage.HasFile)
            {
                ...
                string strExtention = fileName.Substring(fileName.LastIndexOf('.'));
                FileExtentions extention;
                switch (strExtention.ToLower())
                {
                    case ".jpg":
                        extention = FileExtentions.Jpg;
                        break;
                    case ".tiff":
                        extention = FileExtentions.Tiff;
                        break;
                    case ".txt":
                        extention = FileExtentions.Txt;
                        break;
                    case ".doc":
                        extention = FileExtentions.Doc;
                        break;
                    case ".wav":
                        extention = FileExtentions.Wav;
                        break;
                    default:
                        extention = FileExtentions.others;
                        break;
                }


                AttachmentDetails attach = new AttachmentDetails();
                attach.Extention = (byte)extention;
