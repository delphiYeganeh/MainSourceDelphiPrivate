    ...
    public class sqlLetterProvider : Cartable.Dal.LetterProvider
    {
        ...
        public override LetterDetails GetItemById(int Id)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                ...
                {
                    cn.Open();
                    SqlCommand cmd = new SqlCommand("Select * from Letter Where LetterId=" + Id.ToString(), cn);
                    //cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override LetterDetails GetItemByIndicatorId(int IndicatorId, byte MYear, byte SecretariatID, byte Letter_Type, byte letterformat) //*
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                IDataReader reader = null;
        ...
        public override int AddInner(string memo, int userId, string userMemo)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
