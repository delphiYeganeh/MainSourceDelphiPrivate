<%@ page language="C#" masterpagefile="Horizontal.master" autoeventwireup="true" inherits="Cartable.UI.ChangePassword" CodeFile="ChangePassword.aspx.cs" title="اتوماسیون اداری يگانه - تغییر رمز عبور" %>
		...
		<div class="table-chng" cellpadding="4" cellspacing="1">
			...
			<div class="cont-chng-field">
				<div class="cont-chng-button"  >
					...
					<br />
					<asp:ImageButton runat="server" id="btnOK" alternatetext="تغيير رمز" skinid="btnOK" onclick="btnOK_Click" />
					<asp:ImageButton  runat="server" id="btnCancel" alternatetext="انصراف" skinid="btnCancel" onclick="btnCancel_Click" causesvalidation="false" />
				</div>
			</div>
		</div>
	</div>
