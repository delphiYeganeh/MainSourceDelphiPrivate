inherited Fdailyrep: TFdailyrep
  ...
  object sp_dailyRep: TADOStoredProc
    ...
    object sp_dailyRepClassificationtitle: TWideStringField
      FieldName = 'Classificationtitle'
      Size = 50
    end
    object sp_dailyRepUrgencyTitle: TWideStringField
      FieldName = 'UrgencyTitle'
      Size = 50
    end
    object sp_dailyRepFormatTitle: TWideStringField
      FieldName = 'FormatTitle'
      Size = 50
    end
    object sp_dailyRepTemplateTitle: TWideStringField
      FieldName = 'TemplateTitle'
      Size = 50
    end
    object sp_dailyRepSignerTitle: TWideStringField
      FieldName = 'SignerTitle'
      Size = 100
    end
    object sp_dailyRepUserTitle: TWideStringField
      FieldName = 'UserTitle'
      Size = 50
    end
  end
