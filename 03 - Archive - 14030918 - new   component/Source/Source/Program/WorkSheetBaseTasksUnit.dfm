inherited FWorkSheetBaseTasks: TFWorkSheetBaseTasks
  Left = 344
  Top = 160
  Caption = #1578#1593#1585#1610#1601' '#1575#1606#1580#1575#1605' '#1583#1607#1606#1583#1711#1575#1606' Task'
  ClientHeight = 569
  ClientWidth = 931
  KeyPreview = True
  OldCreateOrder = True
  ...
  object MssPanelPro3: TMssPanelPro [0]
    ...
    object GroupBox1: TGroupBox
      ...
      Width = 913
      Height = 158
      Caption = #1605#1588#1582#1589#1575#1578' '#1705#1575#1585' - '#1608#1592#1610#1601#1607
      TabOrder = 0
      DesignSize = (
        913
        158)
      ...
      object MssDBGrid3: TMssDBGrid
        ...
        Columns = <
          item
            ...
            FieldName = 'lkUserID'
            ReadOnly = True
            Title.Caption = #1705#1575#1585#1576#1585'( '#1588#1585#1705#1578' '#1705#1606#1606#1583#1607' '#1583#1585' Task)'
            Width = 309
            Visible = True
          end
          item
  ...
  object QTaskUsers: TADOQuery
    Connection = Dm.YeganehConnection
    CursorType = ctStatic
    BeforePost = QTaskUsersBeforePost
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM WorkSheet_Tasks')
    Left = 401
    Top = 212
    object QTaskUsersID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object QTaskUsersWorkSheetBaseID: TIntegerField
      FieldName = 'WorkSheetBaseID'
    end
    object QTaskUsersUserID: TIntegerField
      FieldName = 'UserID'
    end
    object QTaskUserslkUserID: TStringField
      FieldKind = fkLookup
      FieldName = 'lkUserID'
      LookupDataSet = Dm.QWorkSheetUsers
      LookupKeyFields = 'ID'
    ...
    object QTaskUsersWithAlarm: TBooleanField
      FieldName = 'WithAlarm'
    end
    object QTaskUsersDescription: TStringField
      FieldName = 'Description'
      Size = 3000
    end
    object QTaskUsersUserResponse: TIntegerField
      FieldName = 'UserResponse'
    end
    object QTaskUserslkUserResponse: TStringField
      FieldKind = fkLookup
    ...
    object QTaskUsersUserDescription: TStringField
      FieldName = 'UserDescription'
      Size = 3000
    end
    object QTaskUsersStatus: TIntegerField
      FieldName = 'Status'
    end
    object QTaskUserslkStatus: TStringField
      FieldKind = fkLookup
      FieldName = 'lkStatus'
    ...
    object QTaskUsersRegUserID: TIntegerField
      FieldName = 'RegUserID'
    end
    object QTaskUserslkRegUserID: TStringField
      FieldKind = fkLookup
      FieldName = 'lkRegUserID'
      LookupDataSet = Dm.QWorkSheetUsers
      LookupKeyFields = 'ID'
    ...
    object QTaskUsersRegDate_Shamsi: TStringField
      FieldName = 'RegDate_Shamsi'
      Size = 50
    end
    object QTaskUsersRegDate_Miladi: TStringField
      FieldName = 'RegDate_Miladi'
      Size = 50
    end
  end
  object QAddUserToTask: TADOQuery
    Connection = Dm.YeganehConnection
    Parameters = <>
    Left = 625
    Top = 316
  end
  object QUserInTask: TADOQuery
    Connection = Dm.YeganehConnection
    Parameters = <>
    Left = 617
    Top = 396
  ...
  object dsTaskUsers: TDataSource
    DataSet = QTaskUsers
    Left = 409
    Top = 297
  end
