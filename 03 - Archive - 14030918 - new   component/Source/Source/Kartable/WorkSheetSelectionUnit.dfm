inherited FWorkSheetSelection: TFWorkSheetSelection
  Left = 316
  Top = 157
  ...
  object MssPanelPro2: TMssPanelPro [1]
    ...
    object MssDBGrid2: TMssDBGrid
      ...
      ExOptions = [eoBooleanAsCheckBox, eoCheckBoxSelect, eoDisableDelete, eoDisableInsert, eoENTERlikeTAB, eoKeepSelection, eoStandardPopup, eoDrawBands, eoTitleWordWrap, eoShowFilterBar, eoFilterAutoApply, eoDynamicSearch, eoShowColumnVisibility]
      WidthOfIndicator = 30
      DefaultRowHeight = 17
    ...
    object MssPanelPro3: TMssPanelPro
      ...
      object MssDBGrid1: TMssDBGrid
        ...
        TitleHeight.PixelCount = 24
        FooterColor = clSilver
        ExOptions = [eoBooleanAsCheckBox, eoDisableDelete, eoDisableInsert, eoENTERlikeTAB, eoKeepSelection, eoDrawBands, eoTitleWordWrap, eoShowFilterBar, eoFilterAutoApply, eoShowColumnVisibility]
        WidthOfIndicator = 30
        DefaultRowHeight = 17
        ScrollBars = ssHorizontal
        ColCount = 14
