...
uses
  ...
  StdCtrls, DBCtrls, Mask, ComCtrls, YDbgrid;
...
begin
  inherited;
  if QWorkSheetBaseStatus.AsInteger<>1 then acCaninvited.Enabled:=False
  else if (QWorkSheetBaseManagerUserID.AsInteger=_UserID) or (QWorkSheetBaseMonshi.AsInteger=_UserID) then
