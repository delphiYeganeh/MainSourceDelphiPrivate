      ...
      begin
         ...
         begin
            ...
            MainForm.Sp_Inbox2.Locate('Recommiteid', strtoint(_selectedRecommitesID[i]),[]);
              ...
              Exec_InsertReCommites_autoID(MainForm.sp_inbox2LetterID.AsInteger,3,MainForm.sp_inbox2id.AsInteger,OrgID,Paraph,RecommiteDate,_userid,IsCopy,RecommiteID,DBCheckBox1.Checked);
         end;
      end;
      ...
      begin
         ...
         begin
            ...
            Dm.Sp_Inbox.Locate('Recommiteid', strtoint(_selectedRecommitesID[i]),[]);
              ...
              Exec_InsertReCommites_autoID(dm.sp_inboxLetterID.AsInteger,3,dm.sp_inboxid.AsInteger,OrgID,Paraph,RecommiteDate,_userid,IsCopy,RecommiteID,DBCheckBox1.Checked);
         end;
      end;
  end
end;
...
begin
  ...
  for i:=1 to 8 do TBitBtn(FindComponent('OrgButton'+IntToStr(i))).Caption:=GetUserSetting('DefaultRecieverTitle'+IntToStr(i));
