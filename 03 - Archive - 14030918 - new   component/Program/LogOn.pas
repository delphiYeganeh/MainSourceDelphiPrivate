...
begin
  ...
  begin
    ...
    begin
    //Exec_insert_UserLoginLogout(_userid,IdIPWatch1.LocalIP,IdIPWatch1.LocalName);
      ShowMsg(56);
      Password.SetFocus;
    end
    else
...
begin
  ...
  begin
    ...
    dm.Secretariats.close;
    dm.Secretariats.open;
  ...
  //---
   ...
   _ColorSetting := Dm.GetValue(3000) ;//GetUserSetting('AppModeColor') ;
   _Color5 := clWindow  ;
   if _ColorSetting = 2 then
   begin
      _Color1 := Dm.GetValue(3001) ;
      _Color2 := Dm.GetValue(3002) ;
      _Color3 := Dm.GetValue(3003) ;
      _Color4 := Dm.GetValue(3004) ;
   end
   else
