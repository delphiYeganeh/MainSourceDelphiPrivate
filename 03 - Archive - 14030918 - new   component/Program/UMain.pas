...
begin
  ...
  //Caption := '‰—„ «›“«— »«Ìê«‰Ì '+_yeganeh + ' : ‰”ŒÂ ' + _SoftVersion;
  Caption := '‰—„ «›“«— »«Ìê«‰Ì ‘—ò  ›‰«Ê—Ì «ÿ·«⁄«  Ìê«‰Â' + ' : ‰”ŒÂ ' + _SoftVersion;
...
//        archiveFolderID := 0;
  ...
  Status2.Caption := ' ⁄œ«œ «”‰«œ ò«—»— Ã«—Ì :'+IntToStr(receivedNum);
...
begin
  ...
  begin
    ...
    begin
      ...
      else  lettersDbGrid.Columns.Items[i].Title.Caption:= '„·«ÕŸ«  ò«—»—Ì 1';
    end;
    ...
    begin
      ...
      else  lettersDbGrid.Columns.Items[i].Title.Caption:= '„·«ÕŸ«  ò«—»—Ì 2' ;
    end;
    ...
    begin
      ...
      else lettersDbGrid.Columns.Items[i].Title.Caption:= '„·«ÕŸ«  ò«—»—Ì 3';
    end;
  end;
end;
