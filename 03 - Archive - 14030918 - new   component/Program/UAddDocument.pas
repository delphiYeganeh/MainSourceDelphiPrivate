...
uses
  ...
  xpWindow, xpPages, MssSearchPro, KimiyaEdit,ExportToWord, xpPanel,
  AdvGlowButton;
...
type
  TFrAddDocument= class(TMBaseForm)
    ...
    BBExportToWord: TAdvGlowButton;
    SpeedButton110: TAdvGlowButton;
    ...
    SBUserMemo: TAdvGlowButton;
    SBUserMemo1: TAdvGlowButton;
    SBUserMemo2: TAdvGlowButton;
    ...
    btnRelatedLetters: TAdvGlowButton;
    ...
    procedure DBGToORGKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure ToOrgTitleEditChange(Sender: TObject);
    procedure ToOrgTitleEditKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    ...
    procedure DBGToORGNeedColorCondition(Column: TColumn; State: TGridDrawState; var Color: TColor);
    ...
    procedure UserMemoKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure DBEUserMemo1KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure DBEUserMemo2KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure EdtIndicatorID2KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    ...
    procedure UserMemo1KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure UserMemo1KeyPress(Sender: TObject; var Key: Char);
    procedure YDBUserMemo1CellClick(Column: TColumn);
    procedure YDBUserMemo1KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure YDBUserMemo1NeedColorCondition(Column: TColumn; State: TGridDrawState; var Color: TColor);
    procedure UserMemo2Change(Sender: TObject);
    procedure UserMemo2Exit(Sender: TObject);
    procedure UserMemo2KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure UserMemo2KeyPress(Sender: TObject; var Key: Char);
    procedure YDBUserMemo2CellClick(Column: TColumn);
    procedure YDBUserMemo2KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure YDBUserMemo2NeedColorCondition(Column: TColumn; State: TGridDrawState; var Color: TColor);
    procedure UserMemo3Change(Sender: TObject);
    procedure UserMemo3Exit(Sender: TObject);
    procedure UserMemo3KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure UserMemo3KeyPress(Sender: TObject; var Key: Char);
    procedure YDBUserMemo3CellClick(Column: TColumn);
    procedure YDBUserMemo3KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure YDBUserMemo3NeedColorCondition(Column: TColumn; State: TGridDrawState; var Color: TColor);
    procedure GroupBox4Click(Sender: TObject);
    procedure btnRelatedLettersClick(Sender: TObject);
    procedure Action1Execute(Sender: TObject);
    procedure BitBtn3Click(Sender: TObject);
    procedure YDBGrid1DrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
    ...
    procedure UserMemo1KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure YDBUserMemo1KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure UserMemo2KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure UserMemo3KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure YDBUserMemo3KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure YDBUserMemo2KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
  private
...
Uses
  AddDocumentDM, Dmu, YShamsiDate, FromOrgU, FixedTableF, QuickSearch, UMain,
  FromOrgDialog, DuplicateNo, ExactCopy, BusinessLayer, Math, UaddLetterData,
  UUserTable_Input, SearchFM, ShowAddDocFm, ScanImageFm, LetterArchive, StrUtils,
  LetterEditFm, AlarmFm, LetterRalationFm, SecretariatDocSearchUnit, FFillUserMemoUnit,
  RelatedLetters;
...
begin
  ...
  if pnlDetail.Minimized then
     dm.SetValue(3010,True)
  else dm.SetValue(3010,False) ;
...
begin
  ...
  try
    ...
    FmScanImage._SaveFileType := MainForm._BaseSQLConnection.GetKeyvalue('SaveFileType');
    FmScanImage._IMGDPI := MainForm._BaseSQLConnection.GetKeyvalue('IMGDPI');
...
begin
  inherited;
  // ⁄ÌÌ‰ ”ÿÕ œ” —”Ì
  if Not Dm.GetActionAccess(MainForm.AExpotToWord.Name,MainForm.Tag) then
  begin
...
begin
  ...
  begin
    ...
    //Hamed_Ansari_990228_S
    Dm.SelectLetter := Select_LetterLetterID.AsString;
    //Hamed_Ansari_990228_E
...
//********************
  ...
  YDBUserMemo1.Height := 80 ;
  YDBUserMemo1.Width  := UserMemo1.Width ;
  YDBUserMemo1.Left   := UserMemo1.Left ;
  YDBUserMemo1.Top    := UserMemo1.Height + UserMemo1.Top ;
  YDBUserMemo2.Height := 80 ;
  YDBUserMemo2.Width  := UserMemo2.Width ;
  YDBUserMemo2.Left   := UserMemo2.Left ;
  YDBUserMemo2.Top    := UserMemo2.Height + UserMemo2.Top ;
  YDBUserMemo3.Height := 80 ;
  YDBUserMemo3.Width  := UserMemo3.Width ;
  YDBUserMemo3.Left   := UserMemo3.Left ;
  YDBUserMemo3.Top    := UserMemo3.Height + UserMemo3.Top ;

  xpPageControl1.ActivePageIndex := 0 ;

  if dm.GetValue(3010) = true  then
...
begin
  inherited;
  if Assigned(DMAddDocument) then
  With DMAddDocument do
  begin
    QrLinked.Close;
...
begin
  inherited;
  if Select_Letter.State in [dsEdit,dsInsert] then
    if StrToIntDef(LeftStr(Trim(Select_LetterIncommingdate.AsString),0),_year) > 2000 then
    begin
...
begin
  ...
  if not DataSetEdit.Enabled then
  begin
    if dm.QUserMemo.RecordCount > 0 then
    begin
      if Trim(dm.QUserMemoUserMemo.AsString) <> '' then
      begin
        TEdit(UserMemo1).OnChange := nil;
...
begin
  ...
  begin
    if dm.QUserMemo.RecordCount > 0 then
    begin
      if Trim(dm.QUserMemo1UserMemo1.AsString) <> '' then
      begin
        TEdit(UserMemo2).OnChange:=nil;
...
begin
  ...
  begin
    if dm.QUserMemo.RecordCount > 0 then
    begin
      if trim(dm.QUserMemo2UserMemo2.AsString) <> '' then
      begin
        TEdit(UserMemo3).OnChange:=nil;
...
procedure TFrAddDocument.UserMemo1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TFrAddDocument.YDBUserMemo1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TFrAddDocument.UserMemo2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TFrAddDocument.YDBUserMemo2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TFrAddDocument.UserMemo3KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TFrAddDocument.YDBUserMemo3KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if Ord(Key) = VK_RETURN then
