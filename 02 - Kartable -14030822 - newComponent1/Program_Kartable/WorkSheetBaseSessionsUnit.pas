...
//  ShowMessage(dm.QWorkSheetUsers.SQL.Text);
//  ShowMessage(dm.QWorkSheetUsers.Filter);
   dm.QWorkSheetUsers.SQL.Text := 'SELECT ID,Title FROM Users WHERE [Active]=1';
...
begin
  ...
  begin
      ...
      FWorkSheetNews.NewsContent:='œ⁄Ê  »Â Ã·”Â »« òœ :' + IntToStr(QSessionID.AsInteger);
...
begin
  ...
  QUserInSession.SQL.Add('WHERE WorkSheetBaseID='+QuotedStr(QSessionID.AsString)+' AND UserID='+QuotedStr(Dm.QWorkSheetUsersID.AsString)+'');
  QUserInSession.Open;
