...
uses
  ...
  StdCtrls, DBCtrls, Mask, ComCtrls, YDbgrid, AppEvnts, AdvGlowButton;
...
begin
  ...
  begin
     ...
     begin
          ShowMessage('Ê«—œ ò—œ‰ „Ê÷Ê⁄ «Ã»«—Ì „Ì »«‘œ');
          DBEdit8.SetFocus;
          Abort;
     end;
