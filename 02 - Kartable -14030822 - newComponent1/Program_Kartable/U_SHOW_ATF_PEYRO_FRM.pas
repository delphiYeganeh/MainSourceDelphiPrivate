...
SQL.SQL.Add('where Follow_Retroaction_Letter.LetterID = ' + Dm.Sp_InboxLetterID.AsString + '  and Follow_Retroaction_Letter.FR_Kind = 0 ');
SQL.Open;
END
ELSE
if KIND = 1 then
...
SQL.SQL.Add('INNER JOIN dbo.Letter  ON dbo.Letter.LetterID = dbo.Follow_Retroaction_Letter.FR_LetterID                   ');
SQL.SQL.Add('LEFT  JOIN dbo.Subject ON LETTER.SubjectID   = dbo.Subject.SubjectID                                        ');
SQL.SQL.Add('where Follow_Retroaction_Letter.LetterID = ' + Dm.Sp_InboxLetterID.AsString + '  and Follow_Retroaction_Letter.FR_Kind = 1 ');
SQL.Open;
END
end;
