...
uses
  ...
  xpWindow, xpPages, xpBitBtn, Menus,Variants, Spin,LetterRalationFm,
...
begin
  ...
  if  pnlDetail.Minimized then
    SetUserSetting('KartableExitLetterpnlDetailMinimize', 1)
  else SetUserSetting('KartableExitLetterpnlDetailMinimize', 0) ;
...
begin
   ...
   begin
      ...
      FieldByName('FromOrgID').AsInteger    := _UserFromOrgID;//DefaultSFromOrgId; 13990208 ÅÌ‘ ›—÷ ”„  ›—œ ·«êÌ‰ ò‰‰œÂ
...
begin
  ...
  if not Dm.ExecGet_LetterWordFile(Select_LetterLetterID.AsInteger,ReadOnly,
