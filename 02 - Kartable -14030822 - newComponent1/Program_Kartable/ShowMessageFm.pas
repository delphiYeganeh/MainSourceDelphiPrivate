...
uses
  ...
  Buttons, Menus, ADODB, Grids, DBGrids, DBCtrls, Mask, AdvGlowButton;
...
type
  TFmShowMessage = class(TMBaseForm)
    ...
    Label1: TLabel;
    Label3: TLabel;
    SBMessage: TAdvGlowButton;
    SBNews: TAdvGlowButton;
...
begin
  ...
  // AnimateWindow(Handle , AniTime-50, AW_VER_POSITIVE or AW_Hide);
   AnimateWindow(Handle , 1, AW_VER_POSITIVE or AW_Hide);
end;
