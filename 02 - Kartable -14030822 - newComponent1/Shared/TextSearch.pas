...
uses
  ...
  ExtActns,dialogs,  xpBitBtn, Menus, AppEvnts, AdvGlowButton;
...
begin
  inherited;
   ...
   { TODO -oparsa : 14030411 }
    Dm.qtemp.Close;
    Dm.qtemp.SQL.Clear;
    Dm.qtemp.SQL.Add('SELECT IsCopy FROM dbo.ReCommites with(nolock) WHERE LetterID='+IntToStr(letterContainText.FieldByName('LetterID').AsInteger));
    Dm.qtemp.Open;
    Dm.qtemp.Last;
