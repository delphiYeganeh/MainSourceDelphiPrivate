...
uses
    ...
    Buttons,  ExtActns, ActnList, DB, Menus, ComCtrls, ADODB, AppEvnts,
  AdvGlowButton ;
...
begin
  inherited;
   ...
   if DMPhone.SpPhonePhoneID.AsString = '' then
     exit ;   
...
begin
  inherited;
   ...
   try
      ...
      begin
         if  (DMPhone.SpPhonePhoneID.AsString <> '') and  (DMPhone.QrUsersId.AsString <> '') then
         begin
...
begin
  inherited;
   ...
   try
      ...
      begin
         if (DMPhone.SpPhonePhoneID.AsString <> '') and (DMPhone.Q_AccessUsersUserID.AsString <> '') then
         begin
