...
uses
  ...
  ExtCtrls, ComCtrls, baseunit, xpBitBtn, CheckLst, YchecklistBox,
   ExtActns, ActnList, AppEvnts, AdvGlowButton;
...
begin
  inherited;
  UserPanel.Enabled:= MoreUser.Checked;
  pnlOneOrg.Enabled:= OneOrg.Checked;
...
procedure TFrSendMessage.OneOrgClick(Sender: TObject);
begin
  inherited;
  UserPanel.Enabled:= MoreUser.Checked;
  pnlOneOrg.Enabled:= OneOrg.Checked;
