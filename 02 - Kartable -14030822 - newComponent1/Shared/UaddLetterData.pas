...
uses
  ...
  IdCoder3to4, IdCoderMIME, AppEvnts, xpPanel, AdvGlowButton, WordXP, ComObj ,
  OleServer;
...
type
  TFrAddLetterData = class(TMBaseForm)
    ...
    Panel1: TPanel;
    ADeleteAttachments: TAdvGlowButton;
    btnedit: TAdvGlowButton;
    AddBtn: TAdvGlowButton;
    BitBtn2: TAdvGlowButton;
    BitBtn1: TAdvGlowButton;
    BBShow: TAdvGlowButton;
    Panel2: TxpPanel;
    Label1: TLabel;
    popAdd: TPopupMenu;
    N1: TMenuItem;
    N2: TMenuItem;
    btnECE: TAdvGlowButton;
  ...
  RefreshData;
{
 ...
 // btnOpen.Visible:= not ReadOnly;
  ...
  CHK_USER_ACCESS_QRY.SQL.Add('a.FormTag = 8                                                                               ');
  CHK_USER_ACCESS_QRY.SQL.Add('And                                                                                         ');
  CHK_USER_ACCESS_QRY.SQL.Add('aa.ActionID = ''adeletePeyvastInKartabl''                                                   ');
...
begin
  ...
  if Letter_Or_Erja = 'Erja' then
  begin
     dm.Get_RecommitePayvast_by_RecommiteID.Parameters.ParamByName('@RecommiteID').Value := RecommitID;
  ...
  templetterid := Dm.Get_LetterData_by_LetterIDletterid.AsInteger ;
  if Letter_Or_Erja = 'Letter' then
  begin
    with dm,Get_LetterData_by_LetterID do
    begin
      Close;
      Parameters.ParamByName('@LetterID').Value:= templetterid ;
      Open;
    end;
  end;
end;
