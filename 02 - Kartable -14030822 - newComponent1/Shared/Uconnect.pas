...
var
  ...
  Items:TStrings;
  ConnectToArchive : Boolean;
begin
   ConnectToArchive := False;
            ...
            begin
               ...
               begin
                  ...
                  begin
                     ...
                     close;
                     SQL.Text := 'SELECT Value FROM Settings WHERE VariableName = ''ArchiveCheck''';
                     Open;
                     if not IsEmpty then
                      begin
                       if Fields[0].AsInteger = -1 then
                       ConnectToArchive := True;
                      end;
                  end;
               end
               else
