...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Counttif := DM.CountFilesInFolder( Path, Prefix  );
        memo1.Lines.Add (  '  '+ IntToStr(Counttif) + '  =  ⁄œ«œ ›«Ì· Ì«›  ‘œÂ  ') ;
        DM. CreateExcelImagesInFolder(FolderPath, ShellTreeView1.Selected.Item[I].Text,Counttif);
  ...
  begin
   ...
   // DM. CreateExcelImagesInFolder(Path, 'NewImage3',rbPicReverce.ItemIndex);
    ...
    Counttif := DM.CountFilesInFolder( Path, Prefix  );
    memo1.Lines.Add (  '  '+  IntToStr(Counttif) + '  =  ⁄œ«œ ›«Ì· Ì«›  ‘œÂ  ') ;
    DM. CreateExcelImagesInFolder(FolderPath, ExtractFileName(Path),Counttif);
