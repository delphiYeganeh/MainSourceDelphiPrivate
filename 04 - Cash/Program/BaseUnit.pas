...
uses
  ...
  ComCtrls, ExtCtrls, QuickRpt, Menus,QRCtrls, ADODB,SolarCalendarPackage;
...
type
  TYBaseForm = class(TForm)
    ...
    Function MessageShowString(AppMessage: string;ShowCancel:boolean;FormTitle : String = ''):boolean;
...
Function TYBaseForm.MessageShowString(AppMessage: string;ShowCancel:boolean;FormTitle : String = '' ):boolean;
begin
  ShowMessageF:=TShowMessageF.Create(self);
  ShowMessageF.Label1.Caption:=AppMessage;
