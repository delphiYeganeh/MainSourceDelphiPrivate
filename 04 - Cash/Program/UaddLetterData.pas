...
begin
   ...
   begin
       ...
       VersionEditFrom.ShowModal;
       value1:=VersionEditFrom.output.Text;
       value2:=VersionEditFrom.Edit1.Text;
       value3:=VersionEditFrom.MaskEdit1.Text;
       Edit;
        Get_LetterData_by_LetterIDdescription.AsString:=value1;
        Get_LetterData_by_LetterIDVersionNo.AsString:=value2;
        Get_LetterData_by_LetterIDVersionDate.AsString:=value3;
       Post;
   end;
...
begin
   ...
   //Exec_insert_UserLog(4000+ BtnInsert.Tag , dm.Get_All_LetterLetterID.AsInteger);
...
FileExtentions:=UpperCase(ExtractFileExt(FileName));
    ...
    if  (FileExtentions='.MKV') or (FileExtentions='.MP4') or
      (FileExtentions='.DAT') or (FileExtentions='.MP3') or (FileExtentions='.MPEG') or (FileExtentions='.MPG')
    then
      begin
...
begin
 ...
 if not  DirectoryExists(Edit1.Text) then CreateDir('C:\Temp\');
