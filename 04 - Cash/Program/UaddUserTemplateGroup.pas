...
uses
  ...
  YchecklistBox,dialogs, xpWindow, xpBitBtn, ExtCtrls;
...
procedure TFaddUserTemplateGroup.BitBtn2Click(Sender: TObject);
begin
  inherited;
 GroupList.Post;
close;
...
procedure TFaddUserTemplateGroup.SBAllClick(Sender: TObject);
 VAR I: INTEGER;
begin
  inherited;
...
procedure TFaddUserTemplateGroup.SBNoneClick(Sender: TObject);
var  i: integer; 
begin
  inherited;
  FOR I:= 0 to GroupList.Count-1 do
