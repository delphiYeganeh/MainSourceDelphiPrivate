inherited FrReportAccount: TFrReportAccount
  Left = 643
  Top = 167
  Width = 739
  Height = 716
  ...
  object Panel2: TPanel [2]
    ...
    object YDBGrid1: TYDBGrid
      ...
      Align = alClient
      Color = 14934982
      DataSource = dm.DReport_Account2
      ReadOnly = True
      TabOrder = 0
      ...
      TitleSort = True
      AutoInsert = False
      FooterFields = 'Balance3,exist,Count'
      Columns = <
        item
          Expanded = False
          FieldName = 'AccountNo'
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = #1588#1605#1575#1585#1607' '#1705#1575#1585#1605#1606#1583#1610' '
          Visible = False
        end
        item
          Expanded = False
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = #1578#1575#1585#1610#1582' '#1575#1601#1578#1578#1575#1581' '#1581#1587#1575#1576
          Visible = False
        end
        item
          Expanded = False
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = #1588#1585#1608#1593' '#1662#1585#1583#1575#1582#1578' '#1605#1575#1607#1610#1575#1606#1607
          Visible = False
        end
        item
          Expanded = False
        ...
        item
          ...
          FieldName = 'Balance1'
          Title.Alignment = taCenter
          Title.Caption = #1583#1585#1610#1575#1601#1578' '#1608' '#1662#1585#1583#1575#1582#1578
          Visible = False
        end
        item
          Expanded = False
        ...
        item
          ...
          FieldName = 'Balance5'
          Title.Alignment = taCenter
          Title.Caption = #1580#1585#1610#1605#1607' '#1607#1575
          Visible = False
        end
        item
          Expanded = False
          FieldName = 'Balance6'
          Title.Alignment = taCenter
          Title.Caption = #1705#1575#1585#1605#1586#1583
          Visible = False
        end
        item
          Expanded = False
          FieldName = 'Balance7'
          Title.Alignment = taCenter
          Title.Caption = #1587#1608#1583' '#1608#1575#1605
          Visible = False
        end
        item
          Expanded = False
          ...
          Title.Alignment = taCenter
          Title.Caption = #1570#1582#1585#1610#1606' '#1608#1575#1605' '
          Width = 73
          Visible = True
        end
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = #1588#1605#1575#1585#1607' '#1570#1582#1585#1610#1606' '#1608#1575#1605
          Width = 83
          Visible = True
        end
        item
        ...
        item
          Expanded = False
          FieldName = 'BeforLastLoanAmount'
          Title.Caption = #1605#1575#1606#1583#1607' '#1608#1575#1605' '#1605#1575#1602#1576#1604' '#1570#1582#1585
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'BeforLastLoanNo'
          Title.Caption = #1588#1605#1575#1585#1607' '#1608#1575#1605' '#1605#1575#1602#1576#1604' '#1570#1582#1585
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'CountOfNotPaiedLoan'
          Title.Caption = #1578#1593#1583#1575#1583' '#1608#1575#1605' '#1576#1575#1602#1610#1605#1575#1606#1583#1607
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'LastNotPaidLoanNo'
          Title.Caption = #1570#1582#1585#1610#1606' '#1588#1605#1575#1585#1607' '#1608#1575#1605' '#1583#1585' '#1580#1585#1610#1575#1606
          Visible = True
        end>
    end
  end
