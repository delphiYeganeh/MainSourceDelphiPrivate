...
namespace Cartable.Dal
{
    public abstract class LetterProvider : Dal.DataAccess, Model.Dal.IProviderModel<LetterDetails, Int32>
    {
        ...
        protected LetterDetails GetLetterFromReader(IDataReader reader)
        {
            try
            {
                return new LetterDetails(
                    ...
                    (byte)reader["mYear"],
                    (int)reader["secretariatID"],
                    (int)reader["letter_Type"],
                    (int)reader["letterformat"],
                    ...
                    (int)reader["classificationID"],
                    (int)reader["urgencyID"],
                    ...
                    (reader["sendStatusID"] != DBNull.Value ? (int)reader["sendStatusID"] : (int)0),
        ...
        public abstract LetterDetails GetItemByIndicatorId(int IndicatorId, byte MYear, int SecretariatID, int Letter_Type, int letterformat);
        ...
        public abstract int AddInner(string memo, int userId, string userMemo,string html );
