inherited FWorkSheetBaseSessions: TFWorkSheetBaseSessions
  ...
  object MssPanelPro1: TMssPanelPro [0]
    ...
    object MssDBGrid1: TMssDBGrid
      ...
      ExOptions = [eoBooleanAsCheckBox, eoDisableDelete, eoDisableInsert, eoENTERlikeTAB, eoFixedLikeColumn, eoKeepSelection, eoTitleWordWrap, eoShowFilterBar, eoFilterAutoApply, eoShowColumnVisibility]
      WidthOfIndicator = 11
      DefaultRowHeight = 17
  ...
  object MssPanelPro2: TMssPanelPro [1]
    ...
    object MssPanelPro4: TMssPanelPro
      ...
      object MssDBGrid3: TMssDBGrid
        ...
        TitleHeight.PixelCount = 24
        FooterColor = clBtnFace
        ExOptions = [eoBooleanAsCheckBox, eoDisableDelete, eoDisableInsert, eoENTERlikeTAB, eoFixedLikeColumn, eoKeepSelection, eoRowNumber, eoTitleWordWrap, eoShowFilterBar, eoFilterAutoApply, eoShowColumnVisibility]
        WidthOfIndicator = 11
        DefaultRowHeight = 17
        ScrollBars = ssHorizontal
        ColCount = 3
