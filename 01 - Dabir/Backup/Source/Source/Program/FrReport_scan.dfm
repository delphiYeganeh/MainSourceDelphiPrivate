inherited ScanReport: TScanReport
  Left = 255
  Top = 183
  ...
  object Panel1: TPanel [0]
    ...
    object DateFrom: TShamsiDateEdit
      Left = 467
      Top = 19
      Width = 88
      Height = 21
  ...
  object xpPageControl1: TxpPageControl [6]
    Left = 0
    Top = 120
    Width = 719
    Height = 328
    ...
    object xpTabSheet1: TxpTabSheet
      Caption = #1604#1610#1587#1578' '#1606#1575#1605#1607' '#1607#1575#1610' '#1575#1587#1705#1606' '#1606#1588#1583#1607
      Color = clWhite
      BGStyle = bgsNone
      ...
      object YDBGrid2: TYDBGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'FormatTitle'
            Title.Caption = #1588#1705#1604' '#1606#1575#1605#1607
            Width = 187
            Visible = True
          end
          item
          ...
          item
            Expanded = False
            FieldName = 'Scanned'
            Title.Caption = #1578#1593#1583#1575#1583' '#1575#1587#1705#1606' '#1606#1588#1583#1607
            Visible = True
          end>
      end
    end
  ...
  object Report_Scan: TADOStoredProc
    Connection = Dm.YeganehConnection
    CursorType = ctStatic
    ProcedureName = 'Report_Scan'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
    ...
    Left = 292
    Top = 250
    object Report_ScanFormatTitle: TWideStringField
      FieldName = 'FormatTitle'
      Size = 50
    end
    object Report_ScanLetterTypeTitle: TWideStringField
      FieldName = 'LetterTypeTitle'
      Size = 50
    end
    object Report_ScanAll_cnt: TIntegerField
      FieldName = 'All_cnt'
      ReadOnly = True
    end
    object Report_ScanScanned: TIntegerField
      FieldName = 'Scanned'
      ReadOnly = True
    end
  end
  object DReport_Scan: TDataSource
    DataSet = Report_Scan
    Left = 297
    Top = 310
  end
