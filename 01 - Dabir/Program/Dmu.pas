...
uses
   ...
   uCiaTrayIcon, Math, TINYLib_TLB, uUpdateDbScripts, ShellApi, ExcelXP,TlHelp32;
...
type
  ...
  TDm = class(TDataModule)
    ...
    procedure WordApplicationDocumentOpen(ASender: TObject; const Doc: _Document);
...
// _Yeganeh='Ìê«‰Â';
// _EYeganeh='yeganeh';
   _SoftLastUpdate = '1401/10/21';//'1396/02/16';
