...
function  Duplicate_CourseTitle(CourseTitle:widestring; UTID :Integer=0):boolean;
{ TODO -oparsa : 14031207 }
...
function Duplicate_CourseTitle(CourseTitle:widestring; UTID :Integer):boolean;
 var ADOSP:TADOStoredProc;
 begin
  ADOSP:=TADOStoredProc.create(nil);
