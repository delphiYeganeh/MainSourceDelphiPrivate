...
begin
    ...
    QAddTeacher.SQL.Add('INSERT INTO Teacher(TeacherCode,FirstName,LastName,FullName,Title,PhoneNumbers,UTID)');
    QAddTeacher.SQL.Add('VALUES('+QuotedStr(Code)+','+QuotedStr(Name)+','+QuotedStr(Family)+','+QuotedStr(FullName)+','+QuotedStr(Title)+','+QuotedStr(Phone)+','+inttostr(_UTId)+')');
    { TODO -oparsa : 14031207 }
