...
uses
  ...
  DBCtrls, frxBarcode, ImgList;

type
  TFrExamQRep = class(TMBaseForm)
    QuickRep2: TQuickRep;
    ...
    N4: TMenuItem;
    N5: TMenuItem;
    Select_Applicant_by_ExamAndWhereShamsiDate: TStringField;
    N22: TMenuItem;
    ...
    procedure Select_Applicant_by_ExamAndWhereCalcFields(
      DataSet: TDataSet);
...
var
  FrExamQRep: TFrExamQRep;

implementation

uses dmu, YShamsiDate, Upreview, UReport, ADOInt, U_PRINT_REP_01_FRM,
  U_DESING_REP_01_FRM;
...
procedure TFrExamQRep.OpenApplicants;
begin
  inherited;
...
with Select_Applicant_by_ExamAndWhere do
 begin
   ...
   case ordering.ItemIndex of
     0 : Parameters.ParamByName('@Order').Value:='ApplicantCode';
     1 : Parameters.ParamByName('@Order').Value:='Applicant.FullName';
     2 : Parameters.ParamByName('@Order').Value:='cast(Applicant.CustomField2 as int)';
   end;
   Parameters.ParamByName('@OrderType').Value:=cmbOrderType.ItemIndex;
   Open;
 end;
end;

// Amin 1391/10/11 Start
procedure TFrExamQRep.SetFormSender(value: integer);
begin
   _formSender := value;
...
procedure TFrExamQRep.QuickRep1Preview(Sender: TObject);
begin
  inherited;
...
procedure TFrExamQRep.BitBtn2Click(Sender: TObject);
begin
  inherited;
close;
end;

procedure TFrExamQRep.QuickRep2Preview(Sender: TObject);
begin
  inherited;
  Fpreview:=TFpreview.Create(Application);
...
procedure TFrExamQRep.PrintAppNofrx(ShapeName:string);
...
begin
  inherited;
   ...
   try
      ...
      if FormSender = 1 then
         TfrxMemoView(frxRepAnswerPaper.FindComponent('PageNumber')).Memo.Add( '’›ÕÂ '+IntToStr(Select_Applicant_by_ExamAndWhere.RecNo)+' «“ '+IntToStr(Select_Applicant_by_ExamAndWhere.RecordCount))
      else
         TfrxMemoView(frxRepAnswerPaper.FindComponent('PageNumber')).Memo.Add( '’›ÕÂ '+IntToStr(Select_Applicant_by_TrainingCourseID.RecNo)+' «“ '+IntToStr(Select_Applicant_by_TrainingCourseID.RecordCount));
   except
   end;
...
procedure TFrExamQRep.PrintAppNo(ShapeName:string);
  var AppNo: string;
  i,j:byte;
begin
  inherited;
...
procedure TFrExamQRep.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
 PrintAppNo('Q');
...
procedure TFrExamQRep.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
 PrintAppNo('Q_3_');
...
procedure TFrExamQRep.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
PrintAppNo('Q_2_');
...
procedure TFrExamQRep.DetailBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
PrintAppNo('Qa');
...
procedure TFrExamQRep.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
 PrintAppNo('Q_4_');
...
procedure TFrExamQRep.QRDBText39Print(sender: TObject; var Value: String);
begin
  inherited;
 PrintAppNo('Q_6_');
...
procedure TFrExamQRep.btnDesignClick(Sender: TObject);
begin
PopupMenu1.Popup(Left+btnDesign.Left+40,Top+btnDesign.Top+35);
end;

procedure TFrExamQRep.btnReportClick(Sender: TObject);
begin
  inherited;
  OpenApplicants;
...
procedure TFrExamQRep.N11Click(Sender: TObject);
var
...
procedure TFrExamQRep.N21Click(Sender: TObject);  
var
   i : integer;  // Amin 1391/10/11
begin
  inherited;
...
procedure TFrExamQRep.N31Click(Sender: TObject);
var
   i : integer;  // Amin 1391/10/11
begin
  inherited;
...
procedure TFrExamQRep.N41Click(Sender: TObject);   
var
   i : integer;  // Amin 1391/10/11
begin
  inherited;
...
procedure TFrExamQRep.N1Click(Sender: TObject);
var
   i : integer;  // Amin 1391/10/11
begin
  inherited;
...
procedure TFrExamQRep.N2Click(Sender: TObject);
var
   i : integer;  // Amin 1391/10/11
begin
  inherited;
...
procedure TFrExamQRep.N3Click(Sender: TObject);
begin
...
procedure TFrExamQRep.frxRepAnswerPaperProgress(Sender: TfrxReport;
  ProgressType: TfrxProgressType; Progress: Integer);
begin
  inherited;
 //  PrintAppNofrx('q');
...
procedure TFrExamQRep.frxRepAnswerPaperProgressStart(Sender: TfrxReport;
  ProgressType: TfrxProgressType; Progress: Integer);
begin
  inherited;
...
procedure TFrExamQRep.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFrExamQRep.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
...
procedure TFrExamQRep.chkPnlContextPopup(Sender: TObject;
  MousePos: TPoint; var Handled: Boolean);
begin
  inherited;
...
procedure TFrExamQRep.FormShow(Sender: TObject);
var
   ScrText : TStrings;
   i: integer;
begin
...
procedure TFrExamQRep.spnReportChange(Sender: TObject);
begin
  inherited;
   edtHeightDistance.Text := spnReport.Text;
end;

procedure TFrExamQRep.edtHeightDistanceChange(Sender: TObject);
begin
  inherited;
   spnReport.Text := edtHeightDistance.Text;
end;

procedure TFrExamQRep.Panel1Resize(Sender: TObject);
begin
  inherited;
...
procedure TFrExamQRep.FormClose(Sender: TObject; var Action: TCloseAction);
var
   TxtFile : TStrings;
begin
  inherited;
...
procedure TFrExamQRep.xpBitBtn1Click(Sender: TObject);
begin
  inherited;
...
procedure TFrExamQRep.xpBitBtn2Click(Sender: TObject);
begin
  inherited;
   EditsToReport;
  ReportFileName := ExtractFilePath(Application.ExeName)+'\Reports\'+InputBox('¬‰«·Ì“ ¬“„Ê‰',
	     '‰«„ ê“«—‘', '')+'.fr3';
  frxRepAnswerPaper.SaveToFile(ReportFileName);
end;

procedure TFrExamQRep.xpBitBtn3Click(Sender: TObject);
begin
  inherited;
...
procedure TFrExamQRep.EditsToReport;
var
   i: integer;
begin
   exit;
...
procedure TFrExamQRep.ReportToEdits;
begin
//exit;
//   edtFirstLeft.Text := FloatToStr(TfrxCheckBoxView(frxRepAnswerPaper.FindComponent('q1')).Left);
//   edtFirstTop.Text  := FloatToStr(TfrxCheckBoxView(frxRepAnswerPaper.FindComponent('q1')).Top);
...
procedure TFrExamQRep.xpBitBtn4Click(Sender: TObject);
begin
  inherited;
...
procedure TFrExamQRep.SaveCustomCaptions;
var
   strs : tstrings;
begin
   ...
   Dm.closeopenCaptionTable_Custom('');
   { TODO -oparsa : 14031207 }
   Strs.Add( ' œ«‰‘ÃÊ ' + dm.sp_Table_CustomFieldsCaptionCFC1.AsString);
   Strs.Add( ' œ«‰‘ÃÊ ' + dm.sp_Table_CustomFieldsCaptionCFC2.AsString);
   Strs.Add( ' œ«‰‘ÃÊ ' + dm.sp_Table_CustomFieldsCaptionCFC3.AsString);
   Strs.Add( ' œ«‰‘ÃÊ ' + dm.sp_Table_CustomFieldsCaptionCFC4.AsString);
   Strs.Add( ' œ«‰‘ÃÊ ' + dm.sp_Table_CustomFieldsCaptionCFC5.AsString);
   ...
   Dm.closeopenCaptionTable_Custom('Exam');
   { TODO -oparsa : 14031207 }
   Strs.Add( ' ¬“„Ê‰ ' + dm.sp_Table_CustomFieldsCaptionCFC1.AsString);
   Strs.Add( ' ¬“„Ê‰ ' + dm.sp_Table_CustomFieldsCaptionCFC2.AsString);
   Strs.Add( ' ¬“„Ê‰ ' + dm.sp_Table_CustomFieldsCaptionCFC3.AsString);
   Strs.Add( ' ¬“„Ê‰ ' + dm.sp_Table_CustomFieldsCaptionCFC4.AsString);
   Strs.Add( ' ¬“„Ê‰ ' + dm.sp_Table_CustomFieldsCaptionCFC5.AsString);
...
procedure TFrExamQRep.LoadCustomCaptions;
var
   i, j: integer;
...
begin
   ...
   begin
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'CFC1',' œ«‰‘ÃÊ '+dm.sp_Table_CustomFieldsCaptionCFC1.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'CFC2',' œ«‰‘ÃÊ '+dm.sp_Table_CustomFieldsCaptionCFC2.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'CFC3',' œ«‰‘ÃÊ '+dm.sp_Table_CustomFieldsCaptionCFC3.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'CFC4',' œ«‰‘ÃÊ '+dm.sp_Table_CustomFieldsCaptionCFC4.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'CFC5',' œ«‰‘ÃÊ '+dm.sp_Table_CustomFieldsCaptionCFC5.AsString,[rfReplaceAll]);
   end;
   newstrs.Add(' œ«‰‘ÃÊ '+dm.sp_Table_CustomFieldsCaptionCFC1.AsString);
   newstrs.Add(' œ«‰‘ÃÊ '+dm.sp_Table_CustomFieldsCaptionCFC2.AsString);
   newstrs.Add(' œ«‰‘ÃÊ '+dm.sp_Table_CustomFieldsCaptionCFC3.AsString);
   newstrs.Add(' œ«‰‘ÃÊ '+dm.sp_Table_CustomFieldsCaptionCFC4.AsString);
   newstrs.Add(' œ«‰‘ÃÊ '+dm.sp_Table_CustomFieldsCaptionCFC5.AsString);
   ...
   for i:= 0 to frxReport.FieldAliases.Count -1 do
   begin
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'ECuFC1',' ¬“„Ê‰ '+dm.sp_Table_CustomFieldsCaptionCFC1.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'ECuFC2',' ¬“„Ê‰ '+dm.sp_Table_CustomFieldsCaptionCFC2.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'ECuFC3',' ¬“„Ê‰ '+dm.sp_Table_CustomFieldsCaptionCFC3.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'ECuFC4',' ¬“„Ê‰ '+dm.sp_Table_CustomFieldsCaptionCFC4.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'ECuFC5',' ¬“„Ê‰ '+dm.sp_Table_CustomFieldsCaptionCFC5.AsString,[rfReplaceAll]);
   end;
   newstrs.Add(' ¬“„Ê‰ '+dm.sp_Table_CustomFieldsCaptionCFC1.AsString);
   newstrs.Add(' ¬“„Ê‰ '+dm.sp_Table_CustomFieldsCaptionCFC2.AsString);
   newstrs.Add(' ¬“„Ê‰ '+dm.sp_Table_CustomFieldsCaptionCFC3.AsString);
   newstrs.Add(' ¬“„Ê‰ '+dm.sp_Table_CustomFieldsCaptionCFC4.AsString);
   newstrs.Add(' ¬“„Ê‰ '+dm.sp_Table_CustomFieldsCaptionCFC5.AsString);
...
procedure TFrExamQRep.AssignGroupExamToApplicanet(ExamId, _Type: integer);
begin
...
procedure TFrExamQRep.orderingClick(Sender: TObject);
begin
  inherited;
  AssignGroupExamToApplicanet (dm.Browse_ExamExamID.AsInteger,ordering.ItemIndex);
end;

procedure TFrExamQRep.N4Click(Sender: TObject);
begin
  inherited;
   ReportFileName:='';
   frxReport.DataSet := Select_Applicant_by_ExamAndWhere;
   ...
   if ReportFileName='' then
      ReportFileName := ExtractFilePath(Application.ExeName)+'Reports\ExamCard.fr3';
   if not DirectoryExists(ExtractFilePath(Application.ExeName)+'Reports') then
      CreateDir(ExtractFilePath(Application.ExeName)+'Reports');
   if Not FileExists(ReportFileName) then
      frxRepAnswerPaper.SaveToFile(ReportFileName)
...
procedure TFrExamQRep.N5Click(Sender: TObject);
begin
  inherited;
  //Add Sanaye 941023
  //«ÌÃ«œ ê“«—‘ ·Ì”  Õ÷Ê— €Ì«»
   ...
   if ReportFileName='' then
      ReportFileName := ExtractFilePath(Application.ExeName)+'Reports\HozorReport.fr3';
   if not DirectoryExists(ExtractFilePath(Application.ExeName)+'Reports') then
      CreateDir(ExtractFilePath(Application.ExeName)+'Reports');
   if Not FileExists(ReportFileName) then
      frxRepAnswerPaper.SaveToFile(ReportFileName)
...
procedure TFrExamQRep.Select_Applicant_by_ExamAndWhereCalcFields(
  DataSet: TDataSet);
begin
  inherited;
  //Add Sanaye 941025
  Select_Applicant_by_ExamAndWhereShamsiDate.AsString := _Today;
end;

procedure TFrExamQRep.N22Click(Sender: TObject);
VAR
FRM : TPRINT_REP_01_FRM;
BEGIN
FRM := TPRINT_REP_01_FRM.Create(Self);
FRM.ADOQuery1.Close;
FRM.ADOQuery1.SQL.Clear;
FRM.ADOQuery1.SQL.Add(' DECLARE @ExamID	int,                          ');
FRM.ADOQuery1.SQL.Add('         @order varchar(100)                   ');
FRM.ADOQuery1.SQL.Add('                                               ');
FRM.ADOQuery1.SQL.Add('SET @ExamID	= ' + dm.Browse_ExamExamID.AsString);
if ordering.ItemIndex=1 then
FRM.ADOQuery1.SQL.Add('SET @order   = ''ApplicantCode''               ')
else
FRM.ADOQuery1.SQL.Add('SET @order   = ''Applicant.LastName''          ');

FRM.ADOQuery1.SQL.Add('SELECT                                                                                                                                                          ');
FRM.ADOQuery1.SQL.Add('Applicant.ApplicantCode,                                                                                                                                        ');
FRM.ADOQuery1.SQL.Add('Applicant.FullName,Applicant.PIC,                                                                                                                               ');
FRM.ADOQuery1.SQL.Add('dbo.GenerateBarcode(Applicant.ApplicantCode)+ case when len (ApplicantExam.GroupExamId)<2 then ''0''+CONVERT(varchar(02),ApplicantExam.GroupExamId) else CONVERT');
FRM.ADOQuery1.SQL.Add('(varchar(02),ApplicantExam.GroupExamId) end Barcode,                                                                                                            ');
FRM.ADOQuery1.SQL.Add('Faculty.FacultyTitle, Major.MajorTitle, Exam.ExamTitle, Course.CourseCode,                                                                                      ');
FRM.ADOQuery1.SQL.Add('Course.CourseCode, Course.CourseTitle, Exam.ExamDate, Exam.TermCode ExamTerm,T.FullName, T.FullName as TeacherTitle, EducationGroup.EducationGroupTitle,        ');
FRM.ADOQuery1.SQL.Add('Exam.CustomField1 as ECF1, Exam.CustomField2 as ECF2, Exam.CustomField3 as ECF3, Exam.CustomField4 as ECF4, Exam.CustomField5 as ECF5 ,GE.Title                 ');
FRM.ADOQuery1.SQL.Add('GroupExamTitle,ApplicantExam.SeatNumber                                                                                                                         ');
FRM.ADOQuery1.SQL.Add('FROM ApplicantExam                                                                                                                                              ');
FRM.ADOQuery1.SQL.Add('inner JOIN  Applicant ON ApplicantExam.ApplicantID = Applicant.ApplicantID                                                                                      ');
FRM.ADOQuery1.SQL.Add('inner JOIN  Exam ON ApplicantExam.ExamID = Exam.ExamID                                                                                                          ');
FRM.ADOQuery1.SQL.Add('Left  JOIN  Teacher T on Exam.TeacherID = T.TeacherID                                                                                                           ');
FRM.ADOQuery1.SQL.Add('left  JOIN  Course ON Exam.MainCourseID = Course.CourseID                                                                                                       ');
FRM.ADOQuery1.SQL.Add('left  JOIN  Major ON Applicant.MajorID = Major.MajorID                                                                                                          ');
FRM.ADOQuery1.SQL.Add('left  JOIN  EducationGroup ON EducationGroup.EducationGroupID = Exam.EducationGroupID                                                                           ');
FRM.ADOQuery1.SQL.Add('left  JOIN  Faculty ON EducationGroup.FacultyID = Faculty.FacultyID                                                                                             ');
FRM.ADOQuery1.SQL.Add('left  JOIN  GroupExam GE on GE.GroupExamId =ApplicantExam.GroupExamId                                                                                           ');
FRM.ADOQuery1.SQL.Add('where Exam.ExamID = cast(@examID as varchar(10))                                                                                                                ');
if Trim(Stno.Resultwhere) <> '' then
FRM.ADOQuery1.SQL.Add('AND '+Stno.Resultwhere);

FRM.ADOQuery1.Open;

FRM.QuickRep2.Preview;

FRM.Free;

end;

procedure TFrExamQRep.N23Click(Sender: TObject);
VAR
FRM : TDESING_REP_01_FRM;
BEGIN
FRM := TDESING_REP_01_FRM.Create(NIL);
FRM.ShowModal;
FRM.Free;
end;

procedure TFrExamQRep.N12Click(Sender: TObject);
var
   str : string;
BEGIN
  inherited;
