...
uses
  ...
  xpWindow, xpBitBtn, CheckLst, YchecklistBox;
...
type
  TFrAddUser = class(TMBaseForm)
    ...
    ADOQuery1: TADOQuery;
    ADOQuery1UTID: TIntegerField;
    ADOQuery1UTName: TStringField;
    DataSource1: TDataSource;
    Label5: TLabel;
    CLBUTIDs: TYchecklistBox;
    Button1: TButton;
...
procedure TFrAddUser.Button1Click(Sender: TObject);
begin
  inherited;
  CLBUTIDs .Fill;
end;
