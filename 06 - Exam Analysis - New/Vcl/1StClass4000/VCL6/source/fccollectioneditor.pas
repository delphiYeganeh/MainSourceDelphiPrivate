...
type
  ...
  public
    ...
    Designer: //{$ifdef fcDelphi4Up}IFormDesigner{$else}TFormDesigner{$endif};
        {$ifdef fcDelphi6Up} IDesigner;
        {$else} {$ifdef fcDelphi4Up} IFormDesigner; {$else} TFormDesigner; {$endif}
        {$endif}
  ...
  procedure fcExecuteCollectionEditor(ACaption: string;
    ADesigner:
        {$ifdef fcDelphi6Up} IDesigner;
        {$else} {$ifdef fcDelphi4Up} IFormDesigner; {$else} TFormDesigner; {$endif}
        {$endif}
//  ADesigner: {$ifdef fcDelphi4Up}IFormDesigner{$else}TFormDesigner{$endif};
