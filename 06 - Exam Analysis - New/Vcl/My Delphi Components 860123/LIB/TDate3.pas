...
Function WantedDate(DateVar : String):String;
...
Begin
 IsDigit:=False;
 if Key='1' Then IsDigit:=True;
 if Key='2' Then IsDigit:=True;
 if Key='3' Then IsDigit:=True;
 if Key='4' Then IsDigit:=True;
 if Key='5' Then IsDigit:=True;
 if Key='6' Then IsDigit:=True;
 if Key='7' Then IsDigit:=True;
 if Key='8' Then IsDigit:=True;
 if Key='9' Then IsDigit:=True;
 if Key='0' Then IsDigit:=True;
End;
