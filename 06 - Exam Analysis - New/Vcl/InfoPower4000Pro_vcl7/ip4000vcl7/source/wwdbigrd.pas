...
type
  ...
  published
    ...
    property ShortCutDittoField: TShortCut read FShortCutDittoField write FShortCutDittoField;
    property ShortCutDittoRecord: TShortCut read FShortCutDittoRecord write FShortCutDittoRecord;
    property Options: TwwDittoOptions read FOptions write FOptions;
  end;
...
//    property OnValidationErrorUsingMask: TwwPictureValidationError read FOnValidationErrorUsingMask write FOnValidationErrorUsingMask;
    ...
    property DisableThemesInTitle: boolean read FDisableThemesInTitle write FDisableThemesInTitle;
  end;
...
//  ACursor: TPoint;
  ...
  begin
    ...
    begin
       ...
       try
          if FGroupFieldName<>'' then with DrawCellInfo do
          begin
...
begin
  ...
  if ShortCut <> scNone then begin
     ...
     begin
        if DittoField(Selectedfield) then
           result:= true;
     end
  end;
end;
