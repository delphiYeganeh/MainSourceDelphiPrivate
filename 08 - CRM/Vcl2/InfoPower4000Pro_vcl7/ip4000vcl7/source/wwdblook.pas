...
begin
   ...
   if AllowClearKey and CanEdit then begin // 12/13/02 - Fix bug where still cleared even though AutoEdit=False
      if FGrid.Visible then begin
