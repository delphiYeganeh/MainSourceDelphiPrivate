  ...
  begin
    ...
    try
      ...
      repeat
        ...
        DoPrintHeader(HeaderRect, PageNumber, LeftText, CenterText, RightText, DoDefault);
...
//        TopOffsetTwips := PixelsToTwipsY(PrnPageOffset.Y);
        ...
        DoPrintFooter(HeaderRect, PageNumber, LeftText, CenterText, RightText, DoDefault);
