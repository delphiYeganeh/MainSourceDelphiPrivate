...
//---------------------------------------------------------------------------
void __fastcall TMainDemo::Button18Click(TObject *Sender)
{
  Screen->Cursor = crHourGlass;
  TForm *tempform = new TTableQueryForm(Application);
  Screen->Cursor = crDefault;
  tempform->ShowModal();
  tempform->Free();
}
...
//---------------------------------------------------------------------------
void __fastcall TMainDemo::Button10Click(TObject *Sender)
{
  Screen->Cursor = crHourGlass;
  TForm *tempform = new TQBEForm(Application);
  Screen->Cursor = crDefault;
  tempform->ShowModal();
  tempform->Free();
}
//---------------------------------------------------------------------------
void __fastcall TMainDemo::Button11Click(TObject *Sender)
{
  Screen->Cursor = crHourGlass;
  TForm *tempform = new TPackMain(Application);
  Screen->Cursor = crDefault;
  tempform->ShowModal();
  tempform->Free();
}
