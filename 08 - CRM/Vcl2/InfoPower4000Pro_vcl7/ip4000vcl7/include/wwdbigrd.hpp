...
class PASCALIMPLEMENTATION TwwDittoAttributes : public System::TObject 
{
...
__published:
	...
	__property Classes::TShortCut ShortCutDittoField = {read=FShortCutDittoField, write=FShortCutDittoField, nodefault};
	__property Classes::TShortCut ShortCutDittoRecord = {read=FShortCutDittoRecord, write=FShortCutDittoRecord, nodefault};
	__property TwwDittoOptions Options = {read=FOptions, write=FOptions, nodefault};
public:
	#pragma option push -w-inl
	/* TObject.Create */ inline __fastcall TwwDittoAttributes(void) : System::TObject() { }
	#pragma option pop
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TwwDittoAttributes(void) { }
	#pragma option pop
...
public:
	...
	__property bool DisableThemesInTitle = {read=FDisableThemesInTitle, write=FDisableThemesInTitle, nodefault};
public:
	#pragma option push -w-inl
