...
begin
  ...
  (*
  if IsDrawingAlpha then
  begin
    DestCanvas.Pen.Style:=psSolid;
    DestCanvas.Pen.Color:=0;
  end;
  //*)
      ...
      case c^ of
        ...
        begin
          ...
          begin
            ...
            if y+maxde < DestY + ofy + NonZoomDestHeight then  // 3.0.0b3
            begin
              ...
              if (x+w < DestX+ofx+NonZoomDestWidth) then  // 3.0.0b3
              begin
                if diff <> nil then
                begin
                  diff^.x := x;
            ...
            begin
              ...
              begin
                // only in edit mode
                Height := trunc((y+maxde+maxh)*fZoom); // 3.0.0b3
                if diffbuf <> nil then
                  freemem(diffbuf);
                exit;
              end;
