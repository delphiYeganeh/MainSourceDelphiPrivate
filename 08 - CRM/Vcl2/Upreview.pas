...
begin
 QrPreview1.VertScrollBar.Position:=QrPreview1.VertScrollBar.Position
 +15;
End;
...
begin
  ...
  onwork.caption:='ÏÑ ÍÇá ˜ÇÑ';
end;

procedure TFpreview.QRPreview1PageAvailable(Sender: TObject;
  PageNum: Integer);
begin
IF PageNum>2 Then If Not(ProgressBar1.Visible) Then ProgressBar1.Visible:=True;
  onwork.caption:='';
