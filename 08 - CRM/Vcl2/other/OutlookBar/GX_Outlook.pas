...
uses
  ...
  Forms, ImgList, stdctrls, ActnList, dialogs;

Type
  TGXOutlookItem = class;
  TGXCustomOutlookBar = class;
  ...
  protected
    ...
    function GetOutlookBar: TGXCustomOutlookBar;
    ...
    property OutlookBar: TGXCustomOutlookBar read GetOutlookBar;
  public
    procedure Change;
    procedure Click;
...
//  TGXOutlookFrameType = (ftIcon, ft
  ...
  TGXCustomOutlookBar = class(TCustomControl)
  private
    FList: TList;
  ...
  TFEGXOutlookBar = class(TGXCustomOutlookBar)
  published
    {$IFDEF VER120}
    property Anchors;
    {$ENDIF}
...
function TGXOutlookItem.GetOutlookBar: TGXCustomOutlookBar;
begin
  result := nil;
...
//********************* TGXCustomOutlookBar **********************
constructor TGXCustomOutlookBar.Create(AOwner: TComponent);
begin
...
Destructor TGXCustomOutlookBar.Destroy;
begin
  FPaintBM.Free;
  Clear;
  FSelectedFont.Free;
...
procedure TGXCustomOutlookBar.FontChange(Sender: TObject);
begin
  UpdatePaint;
end;

procedure TGXCustomOutlookBar.BackgroundChange(Sender: TObject);
begin
  UpdatePaint;
end;

function TGXCustomOutlookBar.GetIcons(Index: Integer): TGXOutlookItems;
begin
  Result := TGXOutlookItems(FList.Items[Index]);
end;

procedure TGXCustomOutlookBar.SetIcons(Index: Integer; Icons: TGXOutlookItems);
begin
  TGXOutlookItems(FList.Items[Index]).Assign(Icons);
end;

procedure TGXCustomOutlookBar.Clear;
begin
...
function TGXCustomOutlookBar.Add: TGXOutlookItems;
begin
...
procedure TGXCustomOutlookBar.Delete(Index: Integer);
begin
...
function TGXCustomOutlookBar.GetCount: Integer;
begin
...
procedure TGXCustomOutlookBar.WMEraseBkgnd(var Msg: TMessage);
begin
  Msg.Result := 1;
end;

function TGXCustomOutlookBar.GetClientRect: TRect;
begin
...
procedure TGXCustomOutlookBar.Loaded;
var
  i, j: integer;
begin
  inherited Loaded;
...
procedure TGXCustomOutlookBar.PaintSlider(ACanvas: TCanvas; Button: Integer; ARect: TRect);
const
  BtnMargin = 4;
...
function TGXCustomOutlookBar.PaintBackground(ACanvas: TCanvas; ARect: TRect): Boolean;
var
  X,Y: Integer;
  XMax,YMax: Integer;
  SRect,DRect: TRect;
...
procedure TGXCustomOutlookBar.PaintButton(ACanvas: TCanvas; Button: Integer; ARect: TRect; State: TGXButtonState);
var
  S: string;
begin
  with ACanvas do
...
procedure TGXCustomOutlookBar.SetButtonHeight;
begin
  Canvas.Font.Assign(FBtnFont);
  FButtonheight := Canvas.TextHeight('Wg') + 8;
end;

procedure TGXCustomOutlookBar.PaintBorder(ACanvas: TCanvas);
var
  ARect: TRect;
begin
...
procedure TGXCustomOutlookBar.Paint;
var
  BtnRect: TRect;
  BtnTop: Integer;
  i: Integer;
...
procedure TGXCustomOutlookBar.SetSelectedButton(Value: Integer);
begin
...
procedure TGXCustomOutlookBar.CreateWnd;
begin
  inherited CreateWnd;
...
procedure TGXCustomOutlookBar.UpdatePaint;
begin
...
procedure TGXCustomOutlookBar.MouseMove(Shift: TShiftState; X, Y: Integer);
var
  Index: Integer;
...
procedure TGXCustomOutlookBar.MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  htResult: TGXHitResult;
  Index: Integer;
  CanChange: Boolean;
...
procedure TGXCustomOutlookBar.CMMouseLeave(var Msg: TMessage);
begin
  inherited;
...
procedure TGXCustomOutlookBar.HitTest(x,y: Integer; var htResult: TGXHitResult; var Index: Integer);
var
  i: Integer;
begin
...
procedure TGXCustomOutlookBar.SetSelectedItem(Value: Integer);
begin
  if Value < 0 then
    Value := -1;
...
procedure TGXCustomOutlookBar.WMSize(var Msg: TWMSize);
begin
  Invalidate;
end;

procedure TGXCustomOutlookBar.SetBackground(Value: TPIcture);
begin
  FBackground.Assign(Value);
  Repaint;
end;

procedure TGXCustomOutlookBar.SetBtnFont(Value: TFont);
begin
  FBtnFont.Assign(Value);
  Repaint;
end;

procedure TGXCustomOutlookBar.SetSelectedFont(Value: TFont);
begin
  FSelectedFont.Assign(Value);
  Repaint;
end;

procedure TGXCustomOutlookBar.ReadData(Reader: TReader);
var
...
procedure TGXCustomOutlookBar.WriteData(Writer: TWriter);
var
  i: Integer;
begin
  with Writer do
...
function TGXCustomOutlookBar.DoWrite: Boolean;
begin
  Result:=(FList.Count > 0);
end;

procedure TGXCustomOutlookBar.DefineProperties(Filer: TFiler);
begin
  inherited DefineProperties(Filer);
  Filer.DefineProperty('List', ReadData, WriteData, DoWrite);
end;

procedure TGXCustomOutlookBar.CMColorChanged(var Msg: TMessage);
begin
  inherited;
  Repaint;
end;

procedure TGXCustomOutlookBar.SetFrameStyle(Value: TGXOutlookFrameStyle);
begin
...
procedure TGXCustomOutlookBar.SetSpacing(Value: Integer);
begin
...
procedure TGXCustomOutlookBar.SetTopSpacing(Value: Integer);
begin
...
procedure TGXCustomOutlookBar.SetWordWrap(Value: Boolean);
begin
...
procedure TGXCustomOutlookBar.DoSlide(NewSection: Integer);
...
procedure TGXCustomOutlookBar.Change;
begin
  if NOT(csLoading in ComponentState) then
...
procedure TGXCustomOutlookBar.TextChange;
begin
  if NOT(csLoading in ComponentState) then
...
procedure TGXCustomOutlookBar.SetImages(const Value: TCustomImageList);
begin
...
procedure TGXCustomOutlookBar.Notification(AComponent: TComponent;
...
procedure TGXCustomOutlookBar.SetScrollBtnStyle(const Value: TGXScrollBtnStyle);
begin
...
procedure TGXCustomOutlookBar.SetButtonColor(const Value: TColor);
begin
...
procedure TGXCustomOutlookBar.SetItemHightlightColor(const Value: TColor);
begin
...
procedure TGXCustomOutlookBar.SetItemHightlightFont(const Value: TFont);
begin
  FItemHightlightFont.Assign(Value);
end;

procedure TGXCustomOutlookBar.SetStripAccChar(const Value: boolean);
begin
...
procedure TGXCustomOutlookBar.DecVisibleFactor;
begin
  Dec(FVisibleFactor);
end;

procedure TGXCustomOutlookBar.IncVisibleFactor;
begin
  Inc(FVisibleFactor);
end;

function TGXCustomOutlookBar.GetVisibleCount: integer;
begin
  result := Count + FVisibleFactor;
end;

function TGXCustomOutlookBar.GetVisibleAfter(Value: integer): integer;
var
  i: integer;
begin
  result := 0;
...
function TGXCustomOutlookBar.GetNextSection(Value: integer): integer;
var
  i: integer;
begin
  result := -1;
...
function TGXCustomOutlookBar.GetPriorSection(Value: integer): integer;
var
  i: integer;
begin
  result := -1;
...
procedure TGXCustomOutlookBar.BarVisibleChange(Item: TGXOutlookItems);
var
  i, j: integer;
  SaveScroll: boolean;
begin
