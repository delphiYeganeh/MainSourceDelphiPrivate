inherited FrViewByCalender: TFrViewByCalender
  ...
  object ActionManager1: TActionManager
    ...
    object Action1: TAction
      Tag = -1
      Caption = #1587#1575#1604' '#1602#1576#1604
      ImageIndex = 0
      ShortCut = 16420
    ...
    object Action3: TAction
      Tag = 1
      Caption = #1587#1575#1604' '#1576#1593#1583
      ImageIndex = 3
      ShortCut = 16419
      OnExecute = Action1Execute
    end
  end
  object Hollydate: TADODataSet
    Connection = Dm.YeganehConnection
    CursorType = ctStatic
    CommandText = 'select Date'#13#10'from  hollyDates'#13#10
    Parameters = <>
    Left = 240
    Top = 152
  end
