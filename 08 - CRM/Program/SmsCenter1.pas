...
// WSDL     : http://www.smsgandom.com:8080/sms/services/SmsCenter?wsdl
// Encoding : UTF-8
// Version  : 1.0
// (2012/06/02 10:01:57 Þ.Ù - 1.33.2.5)
// ************************************************************************ //
...
type
  ...
  // port      : SmsCenter
  // URL       : http://www.smsgandom.com:8080/sms/services/SmsCenter
  // ************************************************************************ //
  ...
  ['{52B6F474-C9D4-178B-B450-021C7D180872}']
    ...
    function  getMessageStatus(const terminalId: WideString; const password: WideString; const magfaId: WideString): WideString; stdcall;
