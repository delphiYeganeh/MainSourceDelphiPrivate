inherited ProductADD: TProductADD
  ...
  object insert_Customer_toProduct: TADOStoredProc
    Connection = Dm.YeganehConnection
    CursorType = ctStatic
    ProcedureName = 'insert_Customer_toProduct;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object delete_Customer_fromProduct: TADOStoredProc
    Connection = Dm.YeganehConnection
    CursorType = ctStatic
    ProcedureName = 'delete_Customer_fromProduct;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
