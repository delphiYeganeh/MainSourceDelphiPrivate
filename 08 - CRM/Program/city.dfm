inherited FrCityEdit: TFrCityEdit
  ...
  object City: TADOQuery
    ...
    object CityCityTitle: TWideStringField
      Alignment = taRightJustify
      FieldName = 'CityTitle'
      Size = 50
    end
    object CityStateId: TIntegerField
      FieldName = 'StateId'
    end
    object CityStateNum: TStringField
      Alignment = taRightJustify
      FieldName = 'StateNum'
      Size = 1
    end
