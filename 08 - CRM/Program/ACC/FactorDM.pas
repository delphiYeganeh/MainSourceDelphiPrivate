...
type
  TDMFactor = class(TDataModule)
    ...
    QrFactorValueAdded: TFloatField;
    QrFactorTotalFactorPrice: TFloatField;
    QrFactorTotalFactorPriceString: TStringField;
    QrFactorDiscount: TFloatField;
    QrFacDetailsDiscountLine: TFloatField;
    QrFacDetailsTotalPriceLine: TFloatField;
    QrFacDetailsLineTotalPrice_Calc: TFloatField;
    QrFacDetailsAddedValueLine_Calc: TFloatField;
    QrFacDetailsAddedValueLine: TFloatField;
    QrFD_ArticleTaxPayerID: TStringField;
    QrArticleTaxPayerID: TStringField;
    QrFacDetailsTaxPayerID: TStringField;
    QrFactorIsNonCash: TBooleanField;
    QrFactorRelatedFactor_ID: TIntegerField;
    QrFactorRelatedNumber: TIntegerField;
    ...
    procedure QrFactorValueAddedGetText(Sender: TField; var Text: String;
      DisplayText: Boolean);
    procedure QrFactorValueAddedSetText(Sender: TField;
      const Text: String);
    procedure QrFactorTotalFactorPriceGetText(Sender: TField;
      var Text: String; DisplayText: Boolean);
    procedure QrFactorTotalFactorPriceSetText(Sender: TField;
      const Text: String);
    procedure QrFacDetailsBeforePost(DataSet: TDataSet);
  private
...
begin
   ...
   QrFactorIsNonCash.AsBoolean := False;
...
begin
   ...
   //----
   PostFactorID := QrFactorFactor_ID.AsInteger;
...
begin
   ...
   QrFactorTotalFactorPriceString.AsString :=  AdadBeHorof(QrFactorTotalFactorPrice.AsInteger)+ ' —Ì«· ';
...
begin
   ...
   QrFacDetailsLineTotalPrice_Calc.AsFloat := QrFacDetailsArtTotalPrice_Calc.AsFloat - QrFacDetailsDiscountLine.AsFloat;
   ...
   QrFacDetailsAddedValueLine_Calc.AsFloat := ((QrFacDetailsLineTotalPrice_Calc.AsFloat  )* valueAdded)/100  ;
...
procedure TDMFactor.QrFactorValueAddedGetText(Sender: TField;
  var Text: String; DisplayText: Boolean);
begin
   Text := CommaSeperate(Sender.AsString);
end;

procedure TDMFactor.QrFactorValueAddedSetText(Sender: TField;
  const Text: String);
begin
   Sender.AsFloat := StrToIntDef(DeleteComma(Text) ,0);
end;

procedure TDMFactor.QrFactorTotalFactorPriceGetText(Sender: TField;
  var Text: String; DisplayText: Boolean);
begin
   Text := CommaSeperate(Sender.AsString);
end;

procedure TDMFactor.QrFactorTotalFactorPriceSetText(Sender: TField;
  const Text: String);
begin
   Sender.AsFloat := StrToIntDef(DeleteComma(Text) ,0);
end;

procedure TDMFactor.QrFacDetailsBeforePost(DataSet: TDataSet);
begin
   QrFacDetailsAddedValueLine.AsFloat := QrFacDetailsAddedValueLine_Calc.AsFloat ;
   QrFacDetailsTotalPriceLine.AsFloat := QrFacDetailsLineTotalPrice_Calc.AsFloat ;
end;
