object DMFactor: TDMFactor
  ...
  object QrFactor: TADOQuery
    ...
    object QrFactorValueAdded: TFloatField
      FieldName = 'ValueAdded'
      OnGetText = QrFactorValueAddedGetText
      OnSetText = QrFactorValueAddedSetText
    end
    object QrFactorTotalFactorPrice: TFloatField
      FieldName = 'TotalFactorPrice'
      OnGetText = QrFactorTotalFactorPriceGetText
      OnSetText = QrFactorTotalFactorPriceSetText
    end
    object QrFactorTotalFactorPriceString: TStringField
      DisplayWidth = 100
      FieldKind = fkCalculated
      FieldName = 'TotalFactorPriceString'
      Size = 100
      Calculated = True
    end
    object QrFactorDiscount: TFloatField
      FieldName = 'Discount'
      DisplayFormat = '#,###'
    end
    object QrFactorIsNonCash: TBooleanField
      FieldName = 'IsNonCash'
    end
    object QrFactorRelatedFactor_ID: TIntegerField
      FieldName = 'RelatedFactor_ID'
    end
    object QrFactorRelatedNumber: TIntegerField
  ...
  object QrFacDetails: TADOQuery
    ...
    BeforePost = QrFacDetailsBeforePost
    ...
    object QrFacDetailsDiscountLine: TFloatField
      FieldName = 'DiscountLine'
      DisplayFormat = '#,###'
    end
    object QrFacDetailsTotalPriceLine: TFloatField
      FieldName = 'TotalPriceLine'
      DisplayFormat = '#,###'
    end
    object QrFacDetailsLineTotalPrice_Calc: TFloatField
      FieldKind = fkCalculated
      FieldName = 'LineTotalPrice_Calc'
      DisplayFormat = '#,###'
      Calculated = True
    end
    object QrFacDetailsAddedValueLine_Calc: TFloatField
      FieldKind = fkCalculated
      FieldName = 'AddedValueLine_Calc'
      DisplayFormat = '#,###'
      Calculated = True
    end
    object QrFacDetailsAddedValueLine: TFloatField
      FieldName = 'AddedValueLine'
      DisplayFormat = '#,###'
    end
    object QrFacDetailsTaxPayerID: TStringField
  ...
  object QrCustomer: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'Select  CustomeriD , CompanyName,PersonTitle,Phone,Address'
      'From Customer'
      'Where (1=1)'
  ...
  object QrArticle: TADOQuery
    ...
    object QrArticleTaxPayerID: TStringField
      DefaultExpression = #1588#1606#1575#1587#1607' '#1605#1608#1583#1610#1575#1606
      FieldName = 'TaxPayerID'
    end
  ...
  object QrFD_Article: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       ,EndBuyPrice,Exist,Tozihat,Barcode,TaxPayerID'
      'From Article'
      '')
    Left = 224
    Top = 144
    ...
    object QrFD_ArticleTaxPayerID: TStringField
      FieldName = 'TaxPayerID'
    end
