...
begin
  ...
  if SpCompareFollowUpReport.RecordCount >0 then
    RCount.Caption := ' ÊÚÏÇÏ : ' +  IntToStr(SpCompareFollowUpReport.RecordCount)
  else RCount.Caption := ' ÊÚÏÇÏ : 0'  ;
  ...
  begin
    ...
    begin
       ...
       begin
         ...
         if  SpCompareFollowUpReportRepId.AsInteger = 1 then
         begin
           LinefooterTitle := 'Ñ˜æÑÏ ÒÇÑÔ Çæá ';

         end
         else if  SpCompareFollowUpReportRepId.AsInteger = 2 then
         begin
             LinefooterTitle := 'Ñ˜æÑÏ ÒÇÑÔ Ïæã ';
         end
         else if  SpCompareFollowUpReportRepId.AsInteger = 3 then
         begin
             LinefooterTitle := 'Ñ˜æÑÏ ÒÇÑÔ Óæã ' ;
         end;
         ...
         if  SpCompareFollowUpReportRepId.AsInteger = 1 then
         begin
           Level1Bar.Title := 'Ñ˜æÑÏ ÒÇÑÔ Çæá '+ ' = '+ inttostr(DSForm.Dataset.recordcount) ;
           Level2Bar.Title := ' ÊÚÏÇÏ '+ ' = '+ inttostr(CountTemp) ;
         end
         else if  SpCompareFollowUpReportRepId.AsInteger = 2 then
         begin
             Level1Bar.Title := 'Ñ˜æÑÏ ÒÇÑÔ Ïæã '+ ' = '+ inttostr(DSForm.Dataset.recordcount);
             Level2Bar.Title := ' ÊÚÏÇÏ '+ ' = '+ inttostr(CountTemp) ;
         end
         else if  SpCompareFollowUpReportRepId.AsInteger = 3 then
         begin
             Level1Bar.Title := 'Ñ˜æÑÏ ÒÇÑÔ Óæã '+ ' = '+ inttostr(DSForm.Dataset.recordcount);
             Level2Bar.Title := ' ÊÚÏÇÏ '+ ' = '+ inttostr(CountTemp) ;
         end;
       end;
       /// Next;
