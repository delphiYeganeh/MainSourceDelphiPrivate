...
uses
  Wordxp,officexp,  YDbgrid,  ADODB, DB, OleServer, StdCtrls, Controls,
...
begin
   ...
   with WordApplication do
    begin
     ChangeFileOpenDirectory(WordFilePath);
...
var PageBreak,Story,f:OleVariant;
 var FirstRecord:boolean;
begin
    PasteDocument(HeaderTemplateFile<>'');

    Story:=wdStory ;f:=false ;
