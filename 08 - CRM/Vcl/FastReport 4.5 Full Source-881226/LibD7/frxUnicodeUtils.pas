...
{$ENDIF}
function AnsiToUnicode(const s: String; Charset: UINT; CodePage: Integer = 0): WideString;
function _UnicodeToAnsi(const WS: WideString; Charset: UINT; CodePage: Integer = 0): string;
...
function AnsiToUnicode(const s: String; Charset: UINT; CodePage: Integer): WideString;
var
...
function _UnicodeToAnsi(const WS: WideString; Charset: UINT; CodePage: Integer): string;
var
  InputLength,
