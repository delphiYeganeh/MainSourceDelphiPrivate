...
const resXML =
'<?xml version="1.0" encoding="utf-8"?><Resources CodePage="1252"><StrRes Name="propActive" Text="Specifies if a dataset is open"/><StrRes Name="propAc' + 
...
'play a title"/><StrRes Name="propAutoSize" Text="!Determines if the crosstab should handle its size automatically"/></Resources>' + 
' ';
