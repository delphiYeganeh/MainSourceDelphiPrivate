...
{$ENDIF}
  ...
  public
    ...
    procedure AddXML(const Str: String);
    procedure Clear;
...
procedure TfrxResources.AddXML(const Str: String);
var
      ...
      begin
        ...
        for idx := 0 to  Count - 1 do
          if Items[idx].Name = 'StrRes' then
            Self.AddW(Items[idx].Prop['Name'], UTF8Decode(frxXMLToStr(Items[idx].Prop['Text'])));
      end;
    end;
  finally
    FXMLRes.Free;
