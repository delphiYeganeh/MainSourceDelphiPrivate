...
uses
  ...
  IdCoderMIME, MssMessage, Spin,wordXp;
...
begin
   ...
   if flag then Dm.UpdateRecommite(Select_LetterLetterID.AsInteger);
...
var
    LetterID,OldSecretariatID:integer;
    RR :Boolean;
...
var LetterID:integer;
    RR :Boolean;
    Letter_Type,OldSecretariatID:Integer;
    mYear: integer; // Amin 1391/12/05
begin
   inherited;
...
begin
  ...
  QTemp.SQL.Add('AND OrgID='+IntToStr(Select_LetterFromOrgID.AsInteger));
