...
begin
  ...
  begin
    ...
    begin
      ...
      // 2.3.1
      case iegColorReductionAlgorithm of
        -1 :  // automatic
          begin
            if NCol >= 128 then
              fMethod := 0
      ...
      case fMethod of
        0: fQT := NQ_CreateNeurQuantizer(SrcBitmap, ColorMap, NCol, iegColorReductionQuality);
...
begin
  ...
  else if fSrcBmp.PixelFormat = ie8p then
  begin
