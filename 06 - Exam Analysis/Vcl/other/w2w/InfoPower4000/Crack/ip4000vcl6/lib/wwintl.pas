...
begin
   ...
   begin
      FBtnViewSummary := '„‘«ÂœÂ Ã“∆Ì« ';
      FBtnViewSummaryHint  := '„‘«ÂœÂ Ã“∆Ì«  Ã” ÃÊÌ ›⁄·Ì';
      FBtnNewSearch  := 'Ã” ÃÊÌ ÃœÌœ';
      FBtnNewSearchHint  := '‘—Ê⁄ Ã” ÃÊÌ ÃœÌœ';
      FFieldOrderLabel  := ' — Ì» ›Ì·œÂ«';
      FFieldOrderHint := '„— » ”«“Ì ·Ì”  ›Ì·œÂ« »’Ê—  Õ—Ê› «·›»« Ì« » — Ì» ﬁ—«— ê—› ‰ ¬‰Â« œ— »«‰ò «ÿ·«⁄« Ì';
      FAlphabeticLabel := 'Õ—Ê› «·›»«';
      FLogicalLabel := '„‰ÿﬁÌ';
      FAllFieldsLabel := 'Â„Â';
      FSearchedFieldsLabel := 'Ã” ÃÊ ‘œÂ';
      FStartingRangeLabel := '‘—Ê⁄ „ÕœÊœÂ';
      FEndingRangeLabel := 'Å«Ì«‰ „ÕœÊœÂ';
      FBtnClearMin := 'Å«ò ò‰';
      FBtnClearMax := 'Å«ò ò‰';
      FBtnClearFilterValue := 'Å«ò ò‰';
      FStartingRangeHint := '‘—Ê⁄ „ÕœÊœÂ Ã” ÃÊ —ÊÌ ›Ì·œ —« Ê«—œ ò‰Ìœ';
      FEndingRangeHint := '«‰ Â«Ì „ÕœÊœÂ Ã” ÃÊ —ÊÌ ›Ì·œ —« Ê«—œ ò‰Ìœ';
      FBtnClearMinHint := 'Å«ò ò—œ‰ ‘—Ê⁄ „ÕœÊœÂ Ã” ÃÊ —ÊÌ ›Ì·œ ';
      FBtnClearMaxHint := 'Å«ò ò—œ‰ «‰ Â«Ì „ÕœÊœÂ Ã” ÃÊ —ÊÌ ›Ì·œ ';
      FBtnClearFilterValueHint:= 'Å«ò ò—œ‰ „ﬁœ«— Ã” ÃÊ —ÊÌ ›Ì·œ ';
      FByValueLabel  := '„ﬁœ«—Ì';
      FByRangeLabel  := '„ÕœÊœÂ «Ì';
      FFieldValueLabel  := '„ﬁœ«— ›Ì·œ';
      FFieldValueHint:= '„ﬁœ«— Ã” ÃÊ —ÊÌ ›Ì·œ —« Ê«—œ ò‰Ìœ';
      FSearchTypeLabel  := '‰Ê⁄ Ã” ÃÊ';
      FSearchTypeHint:= '‰ÕÊÂ Ã” ÃÊ';
      FMatchExactLabel  := '⁄Ì‰ ⁄»«— ';
      FMatchStartLabel  := 'ﬁ”„ Ì «“ ⁄»«—  «“ «» œ«';
      FMatchAnyLabel  := 'ﬁ”„ Ì «“ ⁄»«—  Â— Ã«';
      FCaseSensitiveLabel  := ' ÊÃÂ »Â Õ—Ê› òÊçò Ê »“—ê';
      FCaseSensitiveHint  := 'Ã” ÃÊ »«  ÊÃÂ »Â Õ—Ê› òÊçò Ê »“—ê';
      FNonMatchingLabel := '—òÊ—œÂ«ÌÌ òÂ œ— ‘—«Ìÿ ‰„Ì ê‰Ã‰œ';
      FNonMatchingHint := 'Show records that do not match the field value criteria';
      FSummaryFieldLabel:= '›Ì·œ';
      FSummarySearchLabel:= '‰ÕÊÂ Ã” ÃÊ';
      FSummaryValueLabel := '„ﬁœ«—';
      {$ifdef wwdelphi4up}
      FSummaryCaption:= ''; { Use default }
      {$endif}
      FFieldsLabel:= '›Ì·œÂ«';
      FValueRangeTabHint := 'Ã” ÃÊ —ÊÌ ›Ì·œÂ« »’Ê—  „ﬁœ«—Ì Ì« „ÕœÊœÂ «Ì';
      FAllSearchedTabHint := '‰„«Ì‘  „«„ ›Ì·œÂ« Ì« ›ﬁÿ ›Ì·œÂ«Ì Ã” ÃÊ ‘œÂ ›⁄·Ì';
...
//      {$endif}
   ...
   begin
      SearchCharLabel:= '⁄»«—  »—«Ì Ã” ÃÊ';
      SearchCharShortLabel:= 'Õ—› Ã” ÃÊ';
      SearchByLabel:= 'Ã” ÃÊ —ÊÌ';
      StatusRecLabel:= '‘„«—Â —òÊ—œ';
      StatusOfLabel := '«“';
      SearchCharHint:= 'Õ—Ê› Ã” ÃÊÌ ›“«Ì‰œÂ —« Ê«—œ ò‰Ìœ';
      SearchByHint:= 'Ã” ÃÊ Ê „— » ”«“Ì ›“«Ì‰œÂ';
(*
...
*)
   ...
   begin
      ...
      LocateNoMatches:= '„Ê—œÌ Ì«›  ‰‘œ';
      LocateNoMoreMatches:= '„Ê—œÌ »Ì‘ «“ «Ì‰ Ì«›  ‰‘œ';
...
{      RichEditLoadWarning:= 'Replace current contents with Rich Text from a file?';}
      FilterDlgNoCriteria:= '‘„« ÂÌç „Ê÷Ê⁄Ì —« ÃÂ  Ã” ÃÊ «‰ Œ«» ‰‰„ÊœÂ «Ìœ';
