...
begin
  inherited;
   ...
   try
      ...
      if FormSender = 1 then
         TfrxMemoView(frxRepAnswerPaper.FindComponent('PageNumber')).Memo.Add( 'ÕÝÍå '+IntToStr(Select_Applicant_by_ExamAndWhere.RecNo)+' ÇÒ '+IntToStr(Select_Applicant_by_ExamAndWhere.RecordCount))
      else
         TfrxMemoView(frxRepAnswerPaper.FindComponent('PageNumber')).Memo.Add( 'ÕÝÍå '+IntToStr(Select_Applicant_by_TrainingCourseID.RecNo)+' ÇÒ '+IntToStr(Select_Applicant_by_TrainingCourseID.RecordCount));
   except
   end;
...
begin
  inherited;
   EditsToReport;
  ReportFileName := ExtractFilePath(Application.ExeName)+'\Reports\'+InputBox('ÂäÇáíÒ ÂÒãæä',
	     'äÇã ÒÇÑÔ', '')+'.fr3';
  frxRepAnswerPaper.SaveToFile(ReportFileName);
end;
...
begin
   ...
   Strs.Add( ' ÏÇäÔÌæ ' + dm.sp_Table_CustomFieldsCaptionCFC1.AsString);
   Strs.Add( ' ÏÇäÔÌæ ' + dm.sp_Table_CustomFieldsCaptionCFC2.AsString);
   Strs.Add( ' ÏÇäÔÌæ ' + dm.sp_Table_CustomFieldsCaptionCFC3.AsString);
   Strs.Add( ' ÏÇäÔÌæ ' + dm.sp_Table_CustomFieldsCaptionCFC4.AsString);
   Strs.Add( ' ÏÇäÔÌæ ' + dm.sp_Table_CustomFieldsCaptionCFC5.AsString);

   dm.sp_Table_CustomFieldsCaption.Close;
   dm.sp_Table_CustomFieldsCaption.Parameters.ParamByName('@TableName').Value := 'Exam';
   dm.sp_Table_CustomFieldsCaption.Open;
   Strs.Add( ' ÂÒãæä ' + dm.sp_Table_CustomFieldsCaptionCFC1.AsString);
   Strs.Add( ' ÂÒãæä ' + dm.sp_Table_CustomFieldsCaptionCFC2.AsString);
   Strs.Add( ' ÂÒãæä ' + dm.sp_Table_CustomFieldsCaptionCFC3.AsString);
   Strs.Add( ' ÂÒãæä ' + dm.sp_Table_CustomFieldsCaptionCFC4.AsString);
   Strs.Add( ' ÂÒãæä ' + dm.sp_Table_CustomFieldsCaptionCFC5.AsString);
...
begin
   ...
   begin
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'CFC1',' ÏÇäÔÌæ '+dm.sp_Table_CustomFieldsCaptionCFC1.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'CFC2',' ÏÇäÔÌæ '+dm.sp_Table_CustomFieldsCaptionCFC2.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'CFC3',' ÏÇäÔÌæ '+dm.sp_Table_CustomFieldsCaptionCFC3.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'CFC4',' ÏÇäÔÌæ '+dm.sp_Table_CustomFieldsCaptionCFC4.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'CFC5',' ÏÇäÔÌæ '+dm.sp_Table_CustomFieldsCaptionCFC5.AsString,[rfReplaceAll]);
   end;
   newstrs.Add(' ÏÇäÔÌæ '+dm.sp_Table_CustomFieldsCaptionCFC1.AsString);
   newstrs.Add(' ÏÇäÔÌæ '+dm.sp_Table_CustomFieldsCaptionCFC2.AsString);
   newstrs.Add(' ÏÇäÔÌæ '+dm.sp_Table_CustomFieldsCaptionCFC3.AsString);
   newstrs.Add(' ÏÇäÔÌæ '+dm.sp_Table_CustomFieldsCaptionCFC4.AsString);
   newstrs.Add(' ÏÇäÔÌæ '+dm.sp_Table_CustomFieldsCaptionCFC5.AsString);
   ...
   for i:= 0 to frxReport.FieldAliases.Count -1 do
   begin
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'ECuFC1',' ÂÒãæä '+dm.sp_Table_CustomFieldsCaptionCFC1.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'ECuFC2',' ÂÒãæä '+dm.sp_Table_CustomFieldsCaptionCFC2.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'ECuFC3',' ÂÒãæä '+dm.sp_Table_CustomFieldsCaptionCFC3.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'ECuFC4',' ÂÒãæä '+dm.sp_Table_CustomFieldsCaptionCFC4.AsString,[rfReplaceAll]);
      frxReport.FieldAliases[i] := StringReplace(frxReport.FieldAliases[i],'ECuFC5',' ÂÒãæä '+dm.sp_Table_CustomFieldsCaptionCFC5.AsString,[rfReplaceAll]);
   end;
   newstrs.Add(' ÂÒãæä '+dm.sp_Table_CustomFieldsCaptionCFC1.AsString);
   newstrs.Add(' ÂÒãæä '+dm.sp_Table_CustomFieldsCaptionCFC2.AsString);
   newstrs.Add(' ÂÒãæä '+dm.sp_Table_CustomFieldsCaptionCFC3.AsString);
   newstrs.Add(' ÂÒãæä '+dm.sp_Table_CustomFieldsCaptionCFC4.AsString);
   newstrs.Add(' ÂÒãæä '+dm.sp_Table_CustomFieldsCaptionCFC5.AsString);
