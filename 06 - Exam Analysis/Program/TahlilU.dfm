inherited FTahlil: TFTahlil
  ...
  object YDBGrid1: TYDBGrid [0]
    ...
    Columns = <
      item
        ...
        Title.Caption = #1578#1593#1583#1575#1583' '#1602#1576#1608#1604#1610
        Width = 115
        Visible = True
      end
      item
        ...
        Title.Caption = #1578#1593#1583#1575#1583' '#1585#1583
        Width = 115
        Visible = True
      end
      item
        ...
        Title.Caption = #1583#1585#1589#1583' '#1602#1576#1608#1604#1610
        Width = 115
        Visible = True
      end
      item
        ...
        Title.Caption = #1583#1585#1589#1583' '#1585#1583
        Width = 115
        Visible = True
      end>
  end
  object Button4: TxpBitBtn [1]
    Left = 27
    Top = 191
    Width = 81
    Height = 35
  ...
  object ds1: TDataSource
    DataSet = Select_Applicant_by_Examid_Tahlil
    Left = 120
    Top = 72
  end
  object Select_Applicant_by_Examid_Tahlil: TADOStoredProc
    Connection = Dm.YeganehConnection
    ProcedureName = 'Select_Applicant_by_Examid_Tahlil'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
    ...
    Left = 368
    Top = 104
    object Select_Applicant_by_Examid_TahlilAcceptCount: TIntegerField
      FieldName = 'AcceptCount'
      ReadOnly = True
    end
    object Select_Applicant_by_Examid_TahlilRejectCount: TIntegerField
      FieldName = 'RejectCount'
      ReadOnly = True
    end
    object Select_Applicant_by_Examid_TahlilAcceptPercent: TBCDField
      FieldName = 'AcceptPercent'
      Precision = 6
      Size = 2
    end
    object Select_Applicant_by_Examid_TahlilRejectPercent: TBCDField
      FieldName = 'RejectPercent'
      Precision = 6
      Size = 2
    end
