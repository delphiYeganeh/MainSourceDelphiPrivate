...
Uses AddLetterDataDM , Dmu, UaddLetterData, YShamsiDate, SysUtils,
  businessLayer, Forms, ScanImageDM;
...
begin
   ...
   begin
      ...
      if FileExists(_ApplicationPath+'tmpFile')then
           ...
           //ShowMessage('path  ' + Path.Text);

           //ShowMessage('tnt ' + TntOpenDialog.filename);

           //ShowMessage(dm.StringToPWide(TntOpenDialog.filename,i));
