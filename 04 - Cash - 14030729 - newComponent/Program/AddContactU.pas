...
type
  TFrAddContact = class(TYBaseForm)
    ...
    PicImage: TImage;
    PicBtn2: TAdvGlowButton;
    sign: TTabSheet;
    SignImage: TImage;
    PicBtn1: TAdvGlowButton;
    DbName:  TDBEdit;
    DBEdit3: TDBEdit;
    DBEdit2: TDBEdit;
    DBEdit5: TDBEdit;
    ...
    PostBtn: TAdvGlowButton;
    CancelBtn: TAdvGlowButton;
    FirstBalance: TAdvGlowButton;
    PerferazeBtn: TAdvGlowButton;
    ...
    Label11: TLabel;
    Label14: TLabel;
    PicDel2: TAdvGlowButton;
    PicDel1: TAdvGlowButton;
    BtnPresenter: TAdvGlowButton;
    FamilyLabel: TCheckBox;
    Label16: TLabel;
    DBLookupComboBox3: TDBLookupComboBox;
    DBCheckBox1: TDBCheckBox;
    Label17: TLabel;
    IMPORT_BTN: TAdvGlowButton;
...
begin
  ...
  begin
    ...
    if State in [dsedit] then
     Caption:=' ÊÌ—«Ì‘ ' +Dm.ContactTypeContactTypeTitle.AsString
    else   if State in [dsinsert] then
      Caption:='  ⁄—Ì› ' +Dm.ContactTypeContactTypeTitle.AsString + ' ÃœÌœ '
    else Caption:='  ⁄—Ì› ' +Dm.ContactTypeContactTypeTitle.AsString ;
...
begin
  ...
  //if IsInsert then
 //  dm.Report_Account.Locate('AccountID',Dm.Select_AccountAccountID.AsInteger,[]) ;
...
begin
   inherited;
   if Dm.Select_AccountAccountID.AsInteger >0 then
   begin
  ...
  // FrAddPresentationDet.SearchEdit.Text:=Dm.Select_AccountAccountNo.AsString;
   ...
   else  ShowMessage('«» œ« —òÊ—œ ÃœÌœ –ŒÌ—Â ‰„«ÌÌœ ”Å” „⁄—› «Œ ’«’ œÂÌœ');
end;
...
procedure TFrAddContact.AExitExecute(Sender: TObject);
begin
  inherited;
    //  _FoundContactID:= 0 ;
     // _FoundAccountID:= 0 ;
