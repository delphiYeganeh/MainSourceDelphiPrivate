...
begin
  ...
  qry.SQL.Text := 'SELECT 1 FROM [dbo].[Account] WHERE Familyid ='+dm.FamilyFamilyID.AsString ;
  qry.Open;

  if qry.RecordCount>0 then
  begin

    tempstring := '«„ò«‰ Õ–› ÊÃÊœ ‰œ«—œ ° «Ì‰ ' + Get_SystemSetting('FamilyTitle') + ' »«  ' +'"' +IntToStr( qry.RecordCount ) +'"' + ' Õ”«» „— »ÿ „Ì »«‘œ ' + ' ·ÿ›« «» œ« «— »«ÿ Õ–› ‘Êœ Ê ”Å” «ﬁœ«„ »Â Õ–› ‰„«ÌÌœ ';
