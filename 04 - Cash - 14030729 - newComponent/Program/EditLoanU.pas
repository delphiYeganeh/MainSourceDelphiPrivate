...
uses
  ...
  XPStyleActnCtrls, Menus, AdvGlowButton;
  ...
  begin
    ...
    begin
      if (dm.Select_LoanPartsBeginDate.OldValue<>dm.Select_LoanPartsBeginDate.Value)  or
         (DBC_LoanAmount.Enabled and (dm.Select_LoanAmount.OldValue<>dm.Select_LoanAmount.Value)) then
      begin
