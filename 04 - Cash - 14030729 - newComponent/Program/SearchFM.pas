...
uses
  ...
  Grids, DBGrids, ADODB, AdvGlowButton;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        //if FrPrintMonthly.CKLBAccount.Items.Count = 0 then
        ...
        ChLB_SelectItemsFromStr(FrPrintMonthly.CKLBAccount, IntToStr(FrPrintMonthly.AccountID),True);
      end;
    end
    else
    begin
