...
//         Open_Loan_Parts_Details(TempLoanID,Txt_Del254(MEDateFrom.Text),Txt_Del254(MEDateTo.Text),RadioGroup1.ItemIndex);//ÊÛííÑ ßÑÏ Sp ãÊä
         Open_Loan_Parts_Details(TempLoanID,MEDateFrom.Text,MEDateTo.Text,RadioGroup1.ItemIndex);//ÊÛííÑ ßÑÏ Sp ãÊä
         //if Pos(',', CKLBLoanAcc.SelectedCodes) = 0 then // ÏÑ ÕæÑÊíßå íß ÂÊã ÇäÊÎÇÈ ÔÏå ÈæÏ
        if dm.Select_Loan_Parts_Details.RecordCount > 0 then
