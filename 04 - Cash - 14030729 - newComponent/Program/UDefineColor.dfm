inherited FDefineColor: TFDefineColor
  ...
  object MssDBGrid1: TMssDBGrid [10]
    Left = 0
    Top = 376
    Width = 494
    Height = 47
    ...
    Flat = False
    Bands.Strings = (
      #1580#1583#1608#1604' '#1585#1606#1711' '#1607#1575)
    ...
    GridStyle.Bands.Direction = fdBottomToTop
    GridStyle.Bands.EndColor = 4836559
    GridStyle.Title.Direction = fdTopToBottom
    GridStyle.Title.EndColor = 4836559
    TitleHeight.PixelCount = 24
    FooterColor = clBtnFace
    ExOptions = [eoBooleanAsCheckBox, eoENTERlikeTAB, eoKeepSelection, eoStandardPopup, eoShowImgInIndicator, eoDrawBands, eoBLOBEditor, eoTitleWordWrap, eoShowFilterBar, eoFilterAutoApply, eoDynamicSearch, eoShowColumnVisibility]
    WidthOfIndicator = 11
    DefaultRowHeight = 17
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'ID'
        Title.Caption = #1705#1583' '#1585#1606#1711
        Width = 39
        Visible = True
      end
      item
      ...
      item
        ...
        Title.Caption = #1588#1585#1581' '#1583#1587#1578#1585#1587#1610
        Width = 210
        Visible = True
        BandIndex = 0
      end>
  ...
  object AdvOfficeColorSelector1: TAdvOfficeColorSelector [15]
    Left = 383
    Top = 23
    Width = 22
    Height = 19
  ...
  object DBAdvGrid2: TDBAdvGrid [16]
    Left = 0
    Top = 400
    Width = 500
    Height = 25
    ...
    OnGetAlignment = DBAdvGrid2GetAlignment
