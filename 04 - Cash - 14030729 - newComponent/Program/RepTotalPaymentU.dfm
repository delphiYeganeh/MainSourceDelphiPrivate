object FrRepTotalPayment: TFrRepTotalPayment
  Left = 349
  Top = 258
  Width = 611
  Height = 416
  ...
  object Panel1: TPanel
    ...
    object Edt_DocNoFrom: TEdit
      ...
      Anchors = [akTop, akRight]
      TabOrder = 0
      OnKeyPress = Edt_DocNoFromKeyPress
    end
    object Edt_DocNoTo: TEdit
      Left = 179
      Top = 12
      Width = 71
      Height = 21
  ...
  object Panel2: TPanel
    ...
    object YDBGrid1: TYDBGrid
      ...
      Cursor = crHandPoint
      Align = alClient
      DataSource = dm.DRepTotalPayment
