            ...
            begin
               ...
               for i:= 0 to Columns.Count-1 do
                  ...
                  begin
                     ...
                     if (copy(Trim(Columns[i].Field.AsString),5,1) <> '/') and (copy(Trim(Columns[i].Field.AsString),8,1) <> '/') then
                        Data := Trim(Columns[i].Field.AsString)
                        else
                        Data := copy(Trim(Columns[i].Field.AsString),9,2)+'/'+copy(Trim(Columns[i].Field.AsString),6,2)+'/'+copy(Trim(Columns[i].Field.AsString),1,4);
                     if UpperCase(Data) = 'FALSE' then
                        Data := ''
                     else
                        if UpperCase(Data) = 'TRUE' then
          ...
          begin
            ...
            try
             ...
             //ExcelApplication.ActiveCell.FormulaR1C1 := Columns[i].Field.AsString
              Data := Columns[i].Field.AsString;
              if is_Numeric(Data) then
              begin
                ExcelApplication.ActiveCell.NumberFormat := '0';
              end;
...
function TYDBGrid.is_Numeric(s: string): boolean;
var
  i: integer;
begin
  s := Trim(s);
