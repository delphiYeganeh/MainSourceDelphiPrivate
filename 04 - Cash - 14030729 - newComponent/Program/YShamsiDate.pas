...
function ShamsiMonthName(idx : integer) : string;
...
uses u_c_process_list;

var g_c_process_list: c_process_list= Nil;


function ShamsiMonthName(idx : integer) : string;
const Mon: array[1..12] of string=('›—Ê—œÌ‰','«—œÌ»Â‘ ','Œ—œ«œ',' Ì—'
  ,'„—œ«œ','‘Â—ÌÊ—','„Â—','¬»«‰','¬–—','œÌ','»Â„‰','«”›‰œ');
begin
   Result := mon[idx];
end;
...
begin
   ...
   a[37]:='Â“«—';a[38]:='„Ì·ÌÊ‰';a[39]:='„Ì·Ì«—œ';a[40]:=' Ì·Ì«—œ';
   ...
   if (x=1000000000000) then f:=a[40];
end;
