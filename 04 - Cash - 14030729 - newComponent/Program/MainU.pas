...
uses
  ...
  xpPanel, AdvGlassButton, AdvGlowButton, ImgList;
...
type
    ...
    pnlHead1: TxpPanel;
    Btn_H_EftetaheHesab: TAdvGlowButton;
    Btn_H_VirayeshEtelaat: TAdvGlowButton;
    btn_H_VarizHesab: TAdvGlowButton;
    btn_H_BardashtHesab: TAdvGlowButton;
    btn_H_BastanHesab: TAdvGlowButton;
    Panel2     : TPanel;
    AccountGrid: TYDBGrid;
    pnlMainSearch1: TxpPanel;
    Label1     : TLabel;
    Label2     : TLabel;
    Label3     : TLabel;
    Label4     : TLabel;
    pnlHead2: TxpPanel;
    pnlMainSearch2: TxpPanel;
    Panel8     : TPanel;
    YWhereEdit1: TYWhereEdit;
    YWhereEdit2: TYWhereEdit;
    YWhereEdit3: TYWhereEdit;
    AFamilyTitle:TYWhereEdit;
    btn_H_DaftarMoin: TAdvGlowButton;
    btn_H_AghsatVaMahiyaneh: TAdvGlowButton;
    btn512: TAdvGlowButton;
    FamilyLabel: TLabel;
    YWhereEdit4: TYWhereEdit;
    pnlMainSearch3: TxpPanel;
    ForcePaymentGrid: TYDBGrid;
    pnlHead3: TxpPanel;
    btn_AM_TanzimeMahiyaneh: TAdvGlowButton;
    btn_AM_TrifMahiyaneh: TAdvGlowButton;
    TShPhone   : TTabSheet;
    pnlHead4: TxpPanel;
    pnlMainSearch4: TxpPanel;
    Label19    : TLabel;
    Label25    : TLabel;
    Label26    : TLabel;
    BtnSearch2: TAdvGlowButton;
    BtnNew2: TAdvGlowButton;
    Label27    : TLabel;
    btn_V_EtayeVam: TAdvGlowButton;
    btn_V_hazfeVam: TAdvGlowButton;
    btn_V_AghsatInVam: TAdvGlowButton;
    btn_V_OlaviyatBandiVam: TAdvGlowButton;
    btn_V_DarkhasteVam: TAdvGlowButton;
    btn_V_VirayeshAghsat: TAdvGlowButton;
    BtnSearch5: TAdvGlowButton;
    BtnNew5: TAdvGlowButton;
    btn_DT_Jadid: TAdvGlowButton;
    StatusRadioGroup: TRadioGroup;
    btn_AM_PardakhteAghsat: TAdvGlowButton;
    btn_AM_PardakhteMahiyaneh: TAdvGlowButton;
    btn_AM_PardakhteJamee: TAdvGlowButton;
    btn_AM_GazareshTajamoee: TAdvGlowButton;
    btn_DT_Virayesh: TAdvGlowButton;
    btn_DT_Hazf: TAdvGlowButton;
    btn_DT_TasavirMarbooteh: TAdvGlowButton;
    btn_DT_Joaziyat: TAdvGlowButton;
    btn_DT_HesabMortabet: TAdvGlowButton;
    AddObjects: TAction;
    xpTabSheet1: TTabSheet;
    btn_MH_TarazAzmayeshi: TAdvGlowButton;
    GroupBox5: TPanel;
    NoLabel: TLabel;
    Label22: TLabel;
    Accountno: TYWhereEdit;
    FMatureDate: TYWhereEdit;
    SpeedButton51: TAdvGlowButton;
    ...
    BtnSearch4: TAdvGlowButton;
    BtnNew4: TAdvGlowButton;
    SpeedButton5: TAdvGlowButton;
    btn_H_DaftarchehOzviyat: TAdvGlowButton;
    btn_H_VirayeshMahiyaneh: TAdvGlowButton;
    btn_V_DaftarchehAghsat: TAdvGlowButton;
    btn_V_VirayeshVam: TAdvGlowButton;
    CBHasPart    : TCheckBox;
    btn_V_BarresiEmtiyazVam: TAdvGlowButton;
    btn_MH_EnteghalVajh: TAdvGlowButton;
    btn_MH_DaftarMoin: TAdvGlowButton;
    pnlMainSearch5: TxpPanel;
    Label16      : TLabel;
    BtnSearch1: TAdvGlowButton;
    ...
    UserTitmer: TTimer;
    btn_H_DarjHoshdar: TAdvGlowButton;
    btn_MH_Hazf: TAdvGlowButton;
    btn_H_Tasviyeh: TAdvGlowButton;
    btn_MH_DaftareRooznameh: TAdvGlowButton;
    btn_MH_GozareshTarakonesh: TAdvGlowButton;
    btn_MH_BeylanKari: TAdvGlowButton;
    RG_AccountType: TDBTreeView;
    PopupMenu1: TPopupMenu;
    N1: TMenuItem;
    btn_MH_SoodOZiyan: TAdvGlowButton;
    btn_MH_JostejooSanad: TAdvGlowButton;
    ...
    btn_MH_TarazMoin: TAdvGlowButton;
    YWhereEdit22: TYWhereEdit;
    Label7: TLabel;
    LblFamily: TLabel;
    btn_V_TarifAnvaeVam: TAdvGlowButton;
    SpeedButton8: TAdvGlowButton;
    btn_AM_SoodJarimehKarmozd: TAdvGlowButton;
    ...
    btn_MH_Sabt: TAdvGlowButton;
    btn_MH_IjadeHesab: TAdvGlowButton;
    Panel10: TPanel;
    BtnNew3: TAdvGlowButton;
    btnSearch3: TAdvGlowButton;
    Label17: TLabel;
    edtLoanTop: TEdit;
    btn_H_BardashtAzMahiyaneh: TAdvGlowButton;
    btn_V_GozareshVamBeTafkikAza: TAdvGlowButton;
    btn_V_GozareshMoavagheh: TAdvGlowButton;
    btn_AM_GhestBandiMojadad: TAdvGlowButton;
    ...
    TabSheet5: TTabSheet;
    TabSheet6: TTabSheet;
    btnSoodSeporde: TAdvGlowButton;
    TimerSendSms: TTimer;
    Action14: TAction;
    pnlReport: TxpPanel;
    pnlCashSetting: TxpPanel;
    pnlSystemManagement: TxpPanel;
    ...
    SpeedButton25: TAdvGlowButton;
    SpeedButton34: TAdvGlowButton;
    xpBitBtn51: TAdvGlowButton;
    xpBitBtn52: TAdvGlowButton;
    pnlAdvanced: TxpPanel;
    SpeedButton20: TAdvGlowButton;
    SpeedButton14: TAdvGlowButton;
    SpeedButton9: TAdvGlowButton;
    SpeedButton36: TAdvGlowButton;
    SpeedButton37: TAdvGlowButton;
    SpeedButton39: TAdvGlowButton;
    btn_E_ChapePerfraj: TAdvGlowButton;
    SpeedButton38: TAdvGlowButton;
    Sessionbutton: TAdvGlowButton;
    SpeedButton13: TAdvGlowButton;
    SpeedButton24: TAdvGlowButton;
    SpeedButton6: TAdvGlowButton;
    SpeedButton28: TAdvGlowButton;
    speedBtn110: TAdvGlowButton;
    SpeedButton11: TAdvGlowButton;
    SpeedButton40: TAdvGlowButton;
    SpeedButton35: TAdvGlowButton;
    SpeedButton26: TAdvGlowButton;
    SpeedButton27: TAdvGlowButton;
    SpeedButton30: TAdvGlowButton;
    btn_E_GozareshPardakhtAghsatVaMahiyaneh: TAdvGlowButton;
    SpeedButton33: TAdvGlowButton;
    xpBitBtn16: TAdvGlowButton;
    SpeedButton31: TAdvGlowButton;
    btn_E_GozareshGiriAzZamenha: TAdvGlowButton;
    xpBitBtn69: TAdvGlowButton;
    SpeedButton19: TAdvGlowButton;
    SpeedButton29: TAdvGlowButton;
    xpBitBtn63: TAdvGlowButton;
    SpeedButton32: TAdvGlowButton;
    pnlMain: TPanel;
    pnlSearch5: TPanel;
    pnlHead5: TxpPanel;
    pnlSearch4: TPanel;
    ...
    btn_MH_: TAdvGlowButton;
    pnlFacilities: TxpPanel;
    btnShowSearch5: TAdvGlowButton;
    btnShowSearch4: TAdvGlowButton;
    PnlSearch1: TPanel;
    pnlSearch2: TPanel;
    pnlSearch3: TPanel;
    btnShowSearch3: TAdvGlowButton;
    btnShowSearch2: TAdvGlowButton;
    btnShowSearch1: TAdvGlowButton;
    pnlBtn5: TPanel;
    pnlBtn4: TPanel;
    pnlBtn3: TPanel;
    pnlBtn2: TPanel;
    ...
    procedure pnlMainSearch5AfterClose(Sender: TObject);
    procedure btnShowSearch5Click(Sender: TObject);
    procedure pnlMainSearch4AfterClose(Sender: TObject);
    procedure btnShowSearch4Click(Sender: TObject);
    procedure pnlMainSearch3AfterClose(Sender: TObject);
    procedure btnShowSearch3Click(Sender: TObject);
    procedure pnlMainSearch2AfterClose(Sender: TObject);
    procedure btnShowSearch2Click(Sender: TObject);
    procedure pnlMainSearch1AfterClose(Sender: TObject);
    procedure btnShowSearch1Click(Sender: TObject);
    procedure AdvGlowButton2Click(Sender: TObject);
    procedure AdvGlowButton3Click(Sender: TObject);
    procedure AdvGlowButton4Click(Sender: TObject);
    procedure AdvGlowButton5Click(Sender: TObject);
    procedure btn_MH_Click(Sender: TObject);
...
uses dmu,    BusinessLayer,  AddUserU, LoginU,
  ...
  AddLoanTypeU, AddMonthlyTypeU, MakeMonthlyU,// UAddFamily_New ,
  ...
  uSmsSetting, U_ENTER_ADMIN_PASS_FRM, ConvUtils, AddAccessU, UAddFamily,
  UMagnifier;//, AddFamilyU;
...
begin
 ...
 // PageControl1.ActivePageIndex :=  5;
  PageControl1.ActivePageIndex :=  mainPageControl.ActivePage.Tag ;
  pnlTop.Title := MainPageControl.ActivePage.Caption ;  
  ...
  btnShowSearch5.Width := 21 ;
  btnShowSearch4.Width := 21 ;
  btnShowSearch3.Width := 21 ;
  btnShowSearch2.Width := 21 ;
  btnShowSearch1.Width := 21 ;
  ...
  pnlAdvanced.TitleButtons := [tbClose] ;
  pnlCashSetting.TitleButtons := [tbClose] ;
  pnlReport.TitleButtons := [tbClose] ;
  pnlSystemManagement.TitleButtons := [tbClose] ;
...
begin
  ...
  FrmAddFamily:=TFrmAddFamily.Create(Application);
  FrmAddFamily.ShowModal;
...
{   IF  (COPY(dm.Report_CashAccountAccountNO.AsString,1,1)='9')  THEN
    ...
    CashIsDebtor := False;
    Caption := TAdvGlowButton(sender).Caption;
...
begin
  ...
  for i:=0 to ComponentCount-1 do
    if Components[i].ClassNameIs('TAdvGlowButton') then
    begin
      if TAdvGlowButton(Components[i]).Tag <> 1 then
        TAdvGlowButton(Components[i]).Font.Style := [];
      if TAdvGlowButton(Components[i]).Parent.Parent.ClassNameIs('TTabSheet') then
      begin
        TAdvGlowButton(Components[i]).Enabled:= Get_ObjectAccess(_AccessID,TAdvGlowButton(Components[i]).Name);
      end;
    end;
  ...
  Caption := ' ‰—„ «›“«— ’‰œÊﬁ ﬁ—÷ «·Õ”‰Â ‘—ò  ‰—„ «›“«—Ì Ìê«‰Â ' + ' : ‰”ŒÂ ' + _SoftVersion;

  StatusBar.Panels[0].Text := '‰«„ ò«—»—: ' + _userName; //_SoftVersion;
  StatusBar.Panels[2].Text :=  Time_GetTime(Dm.YeganehConnection,False) + '  ' + _Today; // ' «—ÌŒ Ã«—Ì ”Ì” „:' + _Today;
  StatusBar.Panels[3].Text := ' ¬Œ—Ì‰  «—ÌŒ ÊÌ—«Ì‘ ‰—„ «›“«—: ' + _SoftVerLastUpdate;
  
  StatusBar.hint := ' Last up date ' + _SoftVerLastUpdate;

  PageControl1.ActivePageIndex := 0 ;//5;
...
procedure TFrMain.SpeedButton33Click(Sender: TObject);
begin
  Inherited;
...
begin
  ...
  if messageShowString('¬Ì« «“ Õ–› «Ì‰ Õ”«» „ÿ„∆‰ Â” Ìœø  »« Õ–› Õ”«» ò·ÌÂ «ÿ·«⁄«  «⁄„ «“ œ—Ì«›  Ê Å—œ«Œ ° Õﬁ ⁄÷ÊÌ ° Ê«„ Â«  Ê ...  Õ–› „Ì ‘Ê‰œ',true,'«ÿ·«⁄ —”«‰Ì') then
  begin
    if messageShowString('Å” «“ Õ–› «„ò«‰ »«“Ì«»Ì «ÿ·«⁄«  ‰„Ì »«‘œ° ¬Ì« «“ Õ–› «Ì‰ Õ”«» „ÿ„⁄‰ „Ì »«‘Ìœø ',true,'«Œÿ«—') then
    begin
...
begin
  for i:=0 to ComponentCount-1 do
    if Components[i].ClassNameIs('TAdvGlowButton') then
      if TAdvGlowButton(Components[i]).Parent.Parent.ClassNameIs('TTabSheet')  then
        Insert_Objects(Components[i].Name,TAdvGlowButton(Components[i]).Caption,TTabSheet(TAdvGlowButton(Components[i]).Parent.Parent).Caption);
end;
...
begin
  ...
  if PageControl1.ActivePage.Tag  = 5 then
    PageControl1.Images := ImageList0;  
...
begin
  ...
  NoLabel.Caption:='‘„«—Â Ê«„';
  if Dm.Report_LoanLoanNO.AsString <> '' then
...
begin
  inherited;
  AccountID := Get_AccountID_ByAccountNo(dm.Report_LoanAccountno.AsString );
  if AccountID<0 then
  begin
...
procedure TFrMain.SpeedButton32Click(Sender: TObject);
begin
  inherited;
...
begin
 ...
 Make_SelectedForcePayment;
   ...
   if ForcePaymentGrid.DataSource.DataSet.Active and  (ForcePaymentGrid.DataSource.DataSet.RecordCount>0) then
   begin
     FrSumPayment := TFrSumPayment.Create(Application);
...
begin
  ...
  if Loan_has_NotPaidParts(Dm.Report_LoanLoanID.AsInteger) then
    if not messageShowString(' «Ì‰ Ê«„ œ«—«Ì «ﬁ”«ÿ Å—œ«Œ  ‰‘œÂ «”  ¬Ì« «“Õ–› «‰ „ÿ„∆‰ Â” Ìœ',true,'«Œÿ«—') then
      exit;

  if messageShowString(' »« Õ–› Ê«„ «ÿ·«⁄«  Ê«„° «ﬁ”«ÿ° „œ«—ò «“ »Ì‰ „Ì —Êœ ¬Ì« «“ Õ–› Ê«„ «ÿ„Ì‰«‰ œ«—Ìœ',true,'«Œÿ«—') then
  begin
...
begin
  ...
  btn_MH_Sabt.Caption         := ' F1' + dm.AccountTypeCreditCuase.AsString ;
  btn_MH_EnteghalVajh.Caption := ' F2' + dm.AccountTypeDebitCuase.AsString ;
end;
...
procedure TFrMain.SpeedButton31Click(Sender: TObject);
begin
  inherited;
...
begin
 ...
 // FrDaily_Report.btnReport.Caption :='‰„«Ì‘ œ› — —Ê“‰«„Â';
...
begin
 ...
 // FrDaily_Report.btnReport.Caption :='‰„«Ì‘ »Ì·«‰ ò«—Ì';
  FrDaily_Report.showmodal;
end;
...
//      512:BtnName:='btn512';
  ...
  try
    with TAdvGlowButton(FindComponent(BtnName)) do
      if Enabled then
        Click;
  except
  end;
...
procedure TFrMain.SpeedButton39Click(Sender: TObject);
begin
  inherited;
...
begin
  ...
  begin
    try
      if not  Dm.Report_CashAccount.Active then
        Refresh_CashAccount; 
      SearchEdit.Text:= dm.Report_CashAccountAccountNo.AsString;
//         RefreshReportPayment;
    except
...
begin
  ...
  if dm.Report_ForcePaymentForceTypeID.AsInteger = 1 then
  begin
    FrAddRemainLoan.SearchEdit.Text :=  dm.Report_ForcePaymentAccountNo.AsString ;
  end;
...
procedure TFrMain.SpeedButton40Click(Sender: TObject);
begin
  inherited;
...
begin
  ...
  MainPageControl.ActivePageIndex    := PageControl1.ActivePage.Tag;
  ...
  if PageControl1.ActivePage.Tag  = 5 then
   ...
   PageControl1.Images := ImageList3
  else if PageControl1.ActivePage.Tag  = 1 then
   PageControl1.Images := ImageList4
  else if PageControl1.ActivePage.Tag  = 0 then
   PageControl1.Images := ImageList5 ;
...
begin
  ...
  if PageControl1.TabIndex=4 then //1 then
    Refresh_CashAccount;
  { TODO -oparsa : 14030701 }
end;

procedure TFrMain.SetColor;
var acolor :TColor ;
    bcolor :TColor ;
    ModeColor : Integer;
begin
  ...
  acolor     := $00F9F9F2 ; //$00FFF4FA ;
  bcolor     := clSkyBlue;//$00EDFEFE ; //$00FFF4FA ;// $00FFD7EB ; //$00FFD2EB ;
 ...
 //  _Maincolor2 := bcolor ;
   ...
   ModeColor := 0 ;
  if  Get_UserSetting(_Userid,'rgModeColor') = '' then
     ModeColor := 0
  else ModeColor := StrToInt(Get_UserSetting(_Userid,'rgModeColor'));

  if ModeColor = 0 then
  begin
    _Acolor1 := $00FFF1EA ;//clWhite ;
    _Acolor2 := $00E2C7BA;//$00FBF1ED ;
    _Acolor3 := $00FDDBCA; //$00F7DFD6 ;
  end
  else
  if ModeColor = 1 then
  begin
    _Acolor1 := clWhite ;//$00E4E4E4 ;//clWhite;//$00F9F9F2 ;
    _Acolor2 := $00E4E4E4 ;// clWhite ;//clSkyBlue;//$00EDFEFE ; //$00FFF4FA ;//$00FFD7EB ;
    _Acolor3 := $00EAEAEA ;//$00E4E4C5 ;
  end
  else
  if ModeColor = 2 then
  begin
    _Acolor1 := $00F4F8FF ;//clWhite ;
    _Acolor2 := $00D2DDF4 ;
    _Acolor3 := $00B1C1DE ;//$00C4E1FF  ;
  end ;

  _Maincolor1 := _Acolor1 ;
  _Maincolor2 := _Acolor2 ;
  _Maincolor3 := _Acolor3 ;


end;

procedure TFrMain.FormCanResize(Sender: TObject; var NewWidth,
  NewHeight: Integer; var Resize: Boolean);
begin
  inherited;
  if NewHeight > 745 then
  begin
    PageControl1.TabWidth := 120 ;
   // PageControl1.Font.Size := 9 ;
    PageControl1.Font.Style := [fsBold];
  end
  else
  begin
   PageControl1.TabWidth := 105 ;
   PageControl1.Font.Size := 8 ;
   PageControl1.Font.Style := [];
  end;
end;

procedure TFrMain.pnlMainSearch5AfterClose(Sender: TObject);
begin
  inherited;
  btnShowSearch5.Show;
  pnlSearch5.Width := 0 ;
...
procedure TFrMain.btnShowSearch5Click(Sender: TObject);
begin
  inherited;
  btnShowSearch5.Hide ;
  pnlSearch5.Width := 200 ;
  pnlMainSearch5.Show ;
end;

procedure TFrMain.pnlMainSearch4AfterClose(Sender: TObject);
begin
  inherited;
  btnShowSearch4.Show;
  pnlSearch4.Width := 0 ;
...
procedure TFrMain.btnShowSearch4Click(Sender: TObject);
begin
  inherited;
  btnShowSearch4.Hide ;
  pnlSearch4.Width := 200 ;
  pnlMainSearch4.Show ;
end;

procedure TFrMain.pnlMainSearch3AfterClose(Sender: TObject);
begin
  inherited;
  btnShowSearch3.Show;
  pnlSearch3.Width := 0 ;
...
procedure TFrMain.btnShowSearch3Click(Sender: TObject);
begin
  inherited;
  btnShowSearch3.Hide ;
  pnlSearch3.Width := 200 ;
  pnlMainSearch3.Show ;
end;

procedure TFrMain.pnlMainSearch2AfterClose(Sender: TObject);
begin
  inherited;
  btnShowSearch2.Show;
  pnlSearch2.Width := 0 ;
...
procedure TFrMain.btnShowSearch2Click(Sender: TObject);
begin
  inherited;
  btnShowSearch2.Hide ;
  pnlSearch2.Width := 200 ;
  pnlMainSearch2.Show ;
end;

procedure TFrMain.pnlMainSearch1AfterClose(Sender: TObject);
begin
  inherited;
  btnShowSearch1.Show;
  pnlSearch1.Width := 0 ;
...
procedure TFrMain.btnShowSearch1Click(Sender: TObject);
begin
  inherited;
  btnShowSearch1.Hide ;
  pnlSearch1.Width := 200 ;
  pnlMainSearch1.Show ;
end;

procedure TFrMain.AdvGlowButton2Click(Sender: TObject);
begin
  inherited;

  pnlCashSetting.Maximized := True ;

  pnlCashSetting.Visible      := True;
  pnlSystemManagement.Visible := False;
  pnlAdvanced.Visible         := False ;
  pnlReport.Visible           := False ;
end;

procedure TFrMain.AdvGlowButton3Click(Sender: TObject);
begin
  inherited;

  pnlSystemManagement.Maximized := True ;

  pnlCashSetting.Visible      := false;
  pnlSystemManagement.Visible := True;
  pnlAdvanced.Visible         := False ;
  pnlReport.Visible           := False ;
end;

procedure TFrMain.AdvGlowButton4Click(Sender: TObject);
begin
  inherited;

  pnlAdvanced.Maximized := True ;
...
procedure TFrMain.AdvGlowButton5Click(Sender: TObject);
begin
  inherited;

  pnlReport.Maximized := True ;
...
procedure TFrMain.btn_MH_Click(Sender: TObject);
begin
  inherited;
...
begin
  inherited;
  FRM := TFMagnifier.Create(Application);
  FRM.ShowModal;
  FRM.Free;

 //  Application.CreateForm(TFMagnifier, FMagnifier);
