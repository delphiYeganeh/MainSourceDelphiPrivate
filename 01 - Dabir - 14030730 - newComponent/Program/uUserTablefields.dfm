inherited FrTableFields: TFrTableFields
  ...
  object Get_UserFields_By_TableID: TADOStoredProc
    ...
    object Get_UserFields_By_TableIDFieldTypeTitle: TWideStringField
      Alignment = taRightJustify
      FieldKind = fkLookup
      FieldName = 'FieldTypeTitle'
    ...
    object Get_UserFields_By_TableIDReferenceTanleTitle: TWideStringField
      Alignment = taRightJustify
      FieldKind = fkLookup
      FieldName = 'ReferenceTanleTitle'
  ...
  object QryDelFieldAccess: TADOQuery
    Connection = Dm.YeganehConnection
    Parameters = <
      item
        Name = 'FieldID'
