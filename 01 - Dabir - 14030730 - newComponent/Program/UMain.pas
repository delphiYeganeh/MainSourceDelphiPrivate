...
Uses shellapi, windows,forms, BaseUnit, ExtCtrls, Menus, ExtActns, BandActn, Classes,SysUtils,StdCtrls,Dialogs,
  ...
  AppEvnts, AdvGlowButton, CurvyControls, xpPanel, AdvMenus,
  dxGDIPlusClasses;
...
Type
  ...
  TMainForm = class(TMBaseForm)
    ...
    PArchive: TPanel;
    pnlChildArchive: TPanel;
    pnlArchive: TxpPanel;
    RadioGroup1: TRadioGroup;
    SBExpand: TAdvGlowButton;
    SBCollapse: TAdvGlowButton;
    SBArchive: TAdvGlowButton;
    SBSearchArchive: TAdvGlowButton;
    SBCloseArchive: TAdvGlowButton;
    ...
    PtoolBar: TxpPanel;
    lblTime: TLabel;
    pnltoolbarDetail: TxpPanel;
    lblYear: TLabel;
    LblCount: TLabel;
    SBtnHome: TAdvGlowButton;
    SBtnArchive: TAdvGlowButton;
    SBFollowLetter: TAdvGlowButton;
    SpinEdit: TCurvyEdit;
    ...
    procedure SBtnHomeClick(Sender: TObject);
    ...
    procedure SBtnArchiveClick(Sender: TObject);
    ...
    procedure SBCloseArchiveClick(Sender: TObject);
    ...
    procedure SBSearchArchiveClick(Sender: TObject);
...
uses Dmu , FixedTableF, EnteredLetterInputF, ExitedLetterInputF,
     ...
     UchangePassword, ArchiveOrganize, LetterArchive,
...
begin
  ...
  begin
     ...
     FRStatistic  := TFRStatistic.Create(self);
 ...
 // PSearch.Hide;
  ...
  StatisticForm := TStatisticForm.Create(self);
   ...
   StatisticForm.Parent := list;
  //StatisticForm.Parent := panelReport ;//self ; //list.Parent  ;//PSearch.Parent ;
  //StatisticForm.Parent := self ;//list.Parent ;

  StatisticForm.Align := alNone ;//alclient; //alBottom ;//alclient;
  StatisticForm.BorderIcons := [];
  StatisticForm.BorderStyle := bsNone;
  ////// StatisticForm.Show;
 ...
 //  list.Visible := False;
 // PSearch.Hide;
  //// StatisticForm.ShowInPanel(pnlMain);
  PSearch.Hide;
  StatisticForm.Show;
...
procedure TMainForm.SBtnHomeClick(Sender: TObject);
begin
  inherited;
  AHome.Execute;
end;
...
procedure TMainForm.SBtnArchiveClick(Sender: TObject);
begin
  inherited;
  if DisplayMode = Archive then
    Ahome.Execute
...
procedure TMainForm.SBCloseArchiveClick(Sender: TObject);
begin
  inherited;
  DisplayMode:=Search;
end;
...
begin
  ...
  if Column.FieldName = 'HasLetterForms' then
  begin
    if Dm.Get_All_Letterhas_HasLetterForms.AsBoolean then
      ImageIndex := 29
    else
      ImageIndex := 0;
  end;
...
procedure TMainForm.YDBGrid1DblClick(Sender: TObject);
var Lt: integer;
begin
   inherited;
...
procedure TMainForm.YDBGrid1NeedFontCondition(Column: TColumn;State: TGridDrawState; var F: TFont);
begin
   inherited;
...
procedure TMainForm.YDBGrid1NeedImageIndex(Column: TColumn;var ImageIndex: Integer);
begin
   inherited;
...
begin
   ...
   FrFollowUp.refreshData;
   FrFollowUp.Caption := ' “‰ÃÌ—Â ÅÌêÌ—Ì ';
   if sf=0 then
      FrFollowUp.Select_FollowUp_ByStart.Insert;
   FrFollowUp.ShowModal;
   RefreshFollowUP;
...
procedure TMainForm.SBSearchArchiveClick(Sender: TObject);
Var
   I:integer;
begin
   inherited;
...
begin
  ...
  lblTime.Caption := IntToStr(terminationDownCounter);
...
procedure TMainForm.SpinEditKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TMainForm.ButtonolorClick(Sender: TObject);
begin
  inherited;
  ActionToolBar1.Color := clCream ;
//ActionMainMenuBar1

//
end;

procedure TMainForm.UpAndDownBtnClick(Sender: TObject);
begin
  inherited;
   if pnlInformation.Visible=False then
   begin
