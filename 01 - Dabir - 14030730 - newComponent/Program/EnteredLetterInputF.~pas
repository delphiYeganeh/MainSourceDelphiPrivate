...
uses
  ...
  IdCoderMIME, MssMessage, Spin,wordXp, AppEvnts, AdvGlowButton, xpPanel;
...
type
  TReceivedLetterInputForm= class(TMBaseForm)
    ...
    btnPerstian: TAdvGlowButton;
    btnEnglish: TAdvGlowButton;
    ...
    followLabel: TLabel;
    Label23: TLabel;
    btnType: TAdvGlowButton;
    DBEditClassification: TDBEdit;
    DBEditForce: TDBEdit;
    DBEditType: TDBEdit;
    ...
    Label11: TLabel;
    Label16: TLabel;
    DBEditAttach: TDBEdit;
    DBEditPageCount: TDBEdit;
    DBLookupComboBox4: TDBLookupComboBox;
    DBLookupComboBox6: TDBLookupComboBox;
    UserMemo: TYCheckGroupBox;
    UserField: TLabel;
    Label22: TLabel;
    DBEditConsiderations: TDBEdit;
    ...
    procedure btnOtherHistoryClick(Sender: TObject);
    ...
    procedure BtnRelationClick(Sender: TObject);
    procedure btnEnglishClick(Sender: TObject);
    procedure btnPerstianClick(Sender: TObject);
    ...
    procedure DBEditcustomerKeyPress(Sender: TObject; var Key: Char);
...
begin
  ...
  if  pnlDetail.Minimized then
    SetUserSetting('EnterLetterpnlDetailMinimize', 1)
  else SetUserSetting('EnterLetterpnlDetailMinimize', 0) ;
...
begin
 ...
 //-----------------------
  ...
  begin
    ...
    if Trim(DBEditNumber.Text) = '' then
     Select_LetterCenterNo.AsString := Select_LetterIndicatorInnerNo.AsString;
    //else
     //Select_LetterCenterNo.AsString := DBEditNumber.Text;
...
procedure TReceivedLetterInputForm.btnOtherHistoryClick(Sender: TObject);
begin
  inherited;
...
procedure TReceivedLetterInputForm.btninflectionClick(Sender: TObject);
var
  RR :Boolean;
...
procedure TReceivedLetterInputForm.BtnRelationClick(Sender: TObject);
begin
  inherited;
...
procedure TReceivedLetterInputForm.btnEnglishClick(Sender: TObject);
begin
  inherited;
  ...
  btnPerstian.Visible := True ;
  btnEnglish .Visible := False ;
  //---
end;

procedure TReceivedLetterInputForm.btnPerstianClick(Sender: TObject);
begin
  inherited;
  {Ranjbar 89.09.02 ID=230}
  DBEIncommingNO.SetFocus;
  ...
  begin
    ...
    begin
     ...
     {$IFDEF LIGHT}
       ...
       {$ENDIF}
   {$ENDIF}
  DBEditConsiderations.Hint := DBEditConsiderations.Text;
  OldIndicatorId:=Trim(DBEIndicatorID.Text);
...
procedure TReceivedLetterInputForm.btnViewClick(Sender: TObject);
begin
...
procedure TReceivedLetterInputForm.DBEditcustomerKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  Key:=#0;
...
procedure TReceivedLetterInputForm.btnDeleteFormClick(Sender: TObject);
begin
  inherited;
             ...
             begin
                ...
                begin
                    ...
                    begin
                        ...
                        begin
                            Select_Letter.Edit;
                            DBEditReciver.Text:=VarToStr(ND.AttributeNodes.Nodes[j].NodeValue);
                            edit_FromOrgID.Text:='';
                            Select_Letter.Post;
                        end;
                    end;
...
begin
   ...
   btnDeleteForm.Enabled := qry_AccessDeleteHasDelete.AsBoolean;
end;

procedure TReceivedLetterInputForm.cbPersianClick(Sender: TObject);
begin
    if cbPersian.Checked then
      btnPerstianClick(Self)
    else
      btnEnglishClick(Self);
end;
