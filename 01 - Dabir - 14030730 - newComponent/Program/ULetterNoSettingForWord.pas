...
uses
  ...
  Mask, Buttons, ExtCtrls, Menus, DBCtrls, ADODB, AppEvnts, AdvGlowButton;
...
begin
  ...
  begin
      ...
      begin
          ...
          QRY.Close;
          QRY.SQL.Clear;
          QRY.SQL.Add(' SELECT * FROM LetterFormula WHERE SecID='+VarToStr(DBLookupComboBox1.KeyValue)+'and UseForWord=1 ');
          QRY.Open;
          if QRY.RecordCount = 0 then
             BEGIN
             QRY.Close;
             QRY.SQL.Clear;
             QRY.SQL.Add(' INSERT INTO LetterFormula(SecID,UseForWord) VALUES('+VarToStr(DBLookupComboBox1.KeyValue)+',1) ');
             QRY.ExecSQL;
             END;
          QRY.Free;
...
procedure TFrLetterNoSettingForWord.FormShow(Sender: TObject);
begin
  inherited;
//
end;
