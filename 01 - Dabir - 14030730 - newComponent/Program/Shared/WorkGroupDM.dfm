object DMWorkGroup: TDMWorkGroup
  ...
  object FromOrganizations: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      'SELECT Title+'#39' ('#39'+ResponsibleStaffer+'#39')'#39'as Title, ID,  ParentID,' +
      ' Phone, Fax, Email, ResponsibleStaffer, IsActive, PreCode, Code,' +
      ' UniqueID, IsInnerOrg, GroupID FROM FromOrganizations f where Is' +
      'InnerOrg=1 and isactive=1 order by title'
    Parameters = <>
    Left = 270
    Top = 8
