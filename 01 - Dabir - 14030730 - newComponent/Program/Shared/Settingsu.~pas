...
begin
   ...
   rgModeColor.ItemIndex := GetUserSetting('AppModeColor');
   if  rgModeColor.ItemIndex = 2 then
   begin
      ColorBox1.Selected := GetUserSetting('AppMColor1');
      ColorBox2.Selected := GetUserSetting('AppMColor2');
      ColorBox3.Selected := GetUserSetting('AppMColor3');
      ColorBox4.Selected := GetUserSetting('AppMColor4');
   end;
...
//    SetUserSetting('MemoFont','_178'+'_'+ MFont.Font. +'_'+IntToStr(MFont.Font) +'_'+MFont.Font.Name);
   ...
   SetUserSetting('AppModeColor', rgModeColor.ItemIndex);
   _Color5 := clWindow  ;
   ...
   begin      {
      ...
      SetUserSetting('AppMColor1', $00FFF4F4 );
      SetUserSetting('AppMColor2', $00FFD9D9);
      SetUserSetting('AppMColor3', clWhite );
      SetUserSetting('AppodeColor4', $00FFCACA);
   ...
   begin
    ...
    //  _Color3  :=  $0044ACB5 ;
     ...
     // _Color3  := $0025635C ;
      ...
      SetUserSetting('AppMColor1', $00B1D0D1);
      SetUserSetting('AppMColor2', $005FB6BA);
      SetUserSetting('AppMColor3', $002F7B72);
      SetUserSetting('AppodeColor4', $00002F2F);
   end
   else
   if rgModeColor.ItemIndex = 2 then
   begin
      SetUserSetting('AppMColor1', ColorBox1.Selected);
      SetUserSetting('AppMColor2', ColorBox2.Selected);
      SetUserSetting('AppMColor3', ColorBox3.Selected);
      SetUserSetting('AppodeColor4', ColorBox4.Selected);
      {
