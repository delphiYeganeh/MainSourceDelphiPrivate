...
if pos('((l.Letterformat=1))',LetterFilter.Where) > 0 then
   begin
   //ShowMessage(IntToStr( pos('((l.Letterformat=1))',LetterFilter.Where)) );
   s := copy (LetterFilter.Where,25,length(LetterFilter.Where)-25);
   end;
...
begin
 ...
 LetterFilter.DateFieldName := ' RegistrationDate ';
