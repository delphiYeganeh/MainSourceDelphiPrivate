inherited FUserLoginLogoutReport: TFUserLoginLogoutReport
  ...
  Height = 435
  BorderIcons = []
  Caption = #1711#1586#1585#1575#1588#1610' '#1575#1586' '#1608#1585#1608#1583' '#1608' '#1582#1585#1608#1580' '#1705#1575#1585#1576#1585#1575#1606' '#1576#1607' '#1606#1585#1605' '#1575#1601#1586#1575#1585
    ...
    object YDBGrid1: TYDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = #1606#1575#1605' '#1603#1575#1605#1662#1610#1608#1578#1585
          Width = 95
          Visible = True
        end
        item
  ...
  object Select_UserLoginLogout: TADOStoredProc
    ...
    Left = 103
    Top = 106
    object Select_UserLoginLogoutUserName: TWideStringField
      FieldName = 'UserName'
      Size = 50
    end
    object Select_UserLoginLogoutIPAddress: TStringField
      FieldName = 'IPAddress'
      FixedChar = True
      Size = 15
    end
    object Select_UserLoginLogoutComputerName: TStringField
      FieldName = 'ComputerName'
      FixedChar = True
      Size = 30
    end
    object Select_UserLoginLogoutLoginDate: TStringField
      FieldName = 'LoginDate'
      ReadOnly = True
    end
    object Select_UserLoginLogoutLoginTime: TStringField
      FieldName = 'LoginTime'
      ReadOnly = True
      Size = 5
    end
    object Select_UserLoginLogoutLogoutDate: TStringField
      FieldName = 'LogoutDate'
      ReadOnly = True
    end
    object Select_UserLoginLogoutLogoutTime: TStringField
      FieldName = 'LogoutTime'
      ReadOnly = True
      Size = 5
    end
    object Select_UserLoginLogoutisSafeLogout: TBooleanField
      FieldName = 'isSafeLogout'
    end
  end
end
