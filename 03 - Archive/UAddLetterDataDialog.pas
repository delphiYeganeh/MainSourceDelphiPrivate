...
uses
 DB, BaseUnit, ExtActns, ActnMan, Buttons, StdCtrls, Mask, DBCtrls,
  ...
  XMLDoc, TntDialogs , YShamsiDate, xpWindow;
...
uses Dmu, UaddLetterData, Forms, SysUtils, businessLayer,
   ...
   begin
      ...
      begin
          ...
          begin
             ...
             begin
                CopyFile(pchar(path.Text),pchar(path.Text+'tmp'+ExtractFileExt(Path.Text)),false);
                Dm.Get_LetterData_by_LetterDataIDImage.LoadFromFile(Path.Text+'tmp'+ExtractFileExt(Path.Text));
                Post;
      ...
      begin
          ...
          begin
              ...
              begin
                 ...
                 begin
                    CopyFile(pchar(path.Text),pchar(path.Text+'tmp'),false);
                    Dm.Get_RecommitePayvast_by_RecommitePayvastIDImage.LoadFromFile(Path.Text+'tmp');
                    Post;
