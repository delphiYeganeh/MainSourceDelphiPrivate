...
uses  Windows, Messages, SysUtils, Variants, Classes, Graphics,
  Controls, Forms, Dialogs, StdCtrls, OleCtrls, Math,ARM_TLB;
var
...
//begin
//  SetLength(bte1,16);
//  for I := 0 to (strrequest.Length div 2)-1 do
//  begin
//    strTemp:=strRequest.Substring(i*2,2);
//    bte2[i]:=HextoByte(strTemp);
//  end;
//  AES(bte2, bte1,key);
//  Result:=bte1;
...
try
            ...
            begin
                ...
                * x * x - 636636761236 * x + 157440032487) + 938194866 * x -
                ...
                power(94,
                0.6666666666666667)) / (777 * power((111 * sqrt(111) * sqrt(643601678076 * x * x
            ...
            begin
                ...
                sqrt(50627136375 * x * x - 32271294648 * x + 5172382576) + 888195375
                *
                x - 283081532), 0.3333333333333333)) / (135 * power(19, 0.6666666666666667)) - (5296 *
            ...
            begin
                ...
                sqrt(225324323100 * x * x - 87295810115 * x + 8536314174) +
                3918683880
                * x - 759094001), 0.3333333333333333)) / (114 * power(23, 0.6666666666666667)) - (8273 *
                ...
                8536314174)
                + 3918683880 * x - 759094001), 0.3333333333333333)) - 17 / 114;
            end
            else if (a = 7) then
            begin
                R1 := (power((157 / 5), 0.3333333333333333) * power((228 * sqrt(1311) *
                sqrt(225324323100 * x * x - 70643419115 * x + 5707910974) +
                3918683880
                ...
                *
                ...
                5707910974)
                + 3918683880 * x - 614290601), 0.3333333333333333)) - 157 / 114;
            end
            else if (a = 8) then
            begin
                ...
                12198404215540
                * x + 1129413164564) + 179325809685 * x - 32968660042), 0.3333333333333333)) -
                217
                / 297;
            end
            else if (a = 9) then
            ...
            begin
                ...
                x
                + 82326208748) + 4969504485 * x - 904061862), 0.3333333333333333)) - 69 / 97;
            end
            else if (a = 11) then
            begin
                R11:= 1 / 159 ;
            ...
            begin
                ...
                x
                + 2913505) + 119189043 * x - 1566503), 0.3333333333333333)) - 61 / 87;
            end
            else if (a = 13) then
            begin
            ...
            begin
                ...
                7309803898 * x + 14353997) + 950983227 * x - 8250343), 0.3333333333333333)) - 83
                / 129;
            end
            else if (a = 15) then
            begin
                ...
                54161910945604
                * x + 13478975752223) + 249583192758 * x - 124224566389), 0.3333333333333333)) -97 / 219;
            end
            else if (a = 16) then
            begin
                ...
                1741637280
                * x - 279561941), 0.3333333333333333)) / (76 * power(23, 0.6666666666666667)) - (3683 *
            ...
            begin
                ...
                (261
                * power((783 * sqrt(3683) * sqrt(910484786688075 * x * x -
            ...
            begin
                ...
                sqrt(4992799550652 * x * x - 5010668747092 * x + 1257108915479) +
                25736080158 * x - 12914094709), 0.3333333333333333)) / (111 * power(194, 0.6666666666666667))
                + (3556 * power(158, 0.6666666666666667)) / (111 * power(97, 0.3333333333333333) *
                power((111
                * sqrt(10767) * sqrt(4992799550652 * x * x - 5010668747092 * x +
                1257108915479) + 25736080158 * x - 12914094709), 0.3333333333333333)) - 79 /
                111;
            end
            else if (a = 25) then
            begin
            ...
            begin
                ...
                power((124
                * sqrt(2542) * sqrt(47897644720608 * x * x - 47716238418822 * x +
                11884028736721) + 43267971744 * x - 21552049873), 0.3333333333333333)) - 107 /
                372;
            end
            else if (a = 27) then
            begin
            ...
            begin
                ...
                23865288218772
                * x + 3956007114308) + 83900058957 * x - 27815021234), 0.3333333333333333)) - 43
                / 111;
            end
            else if (a = 30) then
            begin
            ...
            begin
                ...
                *
                x + 963972174752) + 65173516461 * x - 21098288720), 0.3333333333333333)) - 167
                /
                309;
            end
            else if (a = 34) then
