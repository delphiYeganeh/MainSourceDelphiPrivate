...
begin
   ...
   Try MFont.Font:=StrToFont(GetUserSetting('MemoFont')); except end;
...
begin
   ...
   SetUserSetting('HasJpg',HasJpg.ItemIndex=0);
   {Ranjbar 89.09.20 ID=247}
...
begin
  ISMessageShow :=  cbAlarmMessage.Checked;
end;

procedure TSettings.FormShow(Sender: TObject);
begin
  cbAlarmMessage.Checked :=  ISMessageShow ;
  {Ranjbar 89.09.20 ID=247}
