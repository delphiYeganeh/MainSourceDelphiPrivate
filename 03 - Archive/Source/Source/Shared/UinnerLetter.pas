...
begin
   ...
   //dm.FromOrganizationsid.AsInteger;
...
//   end;
   ...
   {Ranjbar 89.11.03 ID=291}
   //if not dm.ExecGet_LetterWordFile(select_LetterLetterID.AsInteger,false) then//changes
   if not Dm.ExecGet_LetterWordFile(select_LetterLetterID.AsInteger,Read_Only) then//changes
   //---
   begin
