inherited FrReport_userLog: TFrReport_userLog
  Tag = 10001
  Left = 34
  Top = 193
  Width = 760
  ...
  object YDBGrid1: TYDBGrid [0]
    ...
    AutoInsert = False
    FooterFields = 'Count'
    OnMouseWheel = YDBGrid1MouseWheel
    Columns = <
      item
        Expanded = False
        FieldName = 'UserTitle'
  ...
  object Panel1: TPanel [1]
    ...
    object Label1: TLabel
      ...
      Alignment = taRightJustify
      Anchors = [akTop, akRight]
      Caption = #1593#1605#1604' '#1575#1606#1580#1575#1605' '#1588#1583#1607
      Color = clBtnFace
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
    ...
    object YWhereEdit2: TYWhereEdit
      ...
      EveryLike = False
      isString = False
      FieldName = ' dbo.Shamsi(UserLog.Time1)'
      CodeField = 'Code'
      TitleField = 'Title'
      Connection = Dm.YeganehConnection
    end
    ...
    object dblActions: TDBLookupComboBox
      Left = 360
      Top = 41
      Width = 293
      Height = 21
  ...
  object Report_UserLog: TADOStoredProc
    Connection = Dm.YeganehConnection
    CursorType = ctStatic
    CommandTimeout = 0
    ProcedureName = 'Report_UserLog'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object qryActions: TADOQuery
    ...
    Left = 80
    Top = 168
    object qryActionsFormTag: TWordField
      FieldName = 'FormTag'
    end
    object qryActionsActionName: TWideStringField
      FieldName = 'ActionName'
      Size = 100
    end
    object qryActionsTitle: TWideStringField
      FieldName = 'Title'
      Size = 50
    end
  end
