...
uses
  ...
  ADODB, DBTables, Grids, DBGrids,AdoConEd, YDbgrid, xpWindow;
...
if FoxOpenDialog.Execute then
 begin
  BDETable.Close;
  BDETable.DatabaseName:=ExtractFilePath(FoxOpenDialog.FileName);
  BDETable.TableName:=ExtractFileName(FoxOpenDialog.FileName);
  BDETable.Open;
 end;
